...
**Generator syntax:** `gen cabs N cars M speed S every T` - N cabs (default 1), M cars (default 5), speed S inches/sec (default 12), spawn every T seconds (omit for one-shot). Parameters can appear in any order.
