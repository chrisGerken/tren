...
trees clearance 4 density 3 factor 0.6
random
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      white-space: nowrap;
    `;const r=new Z_(s);r.position.set(t,1,n),this.labelGroup.add(r)}setLabelsVisible(e){this.labelGroup.visible=e,this.labelRenderer.domElement.style.display=e?"block":"none"}getLabelsVisible(){return this.labelGroup.visible}fitToLayout(){if(this.trackGroup.children.length===0)return;const e=new Fn().setFromObject(this.trackGroup);this.layoutBounds=e;const t=e.getCenter(new L),n=e.getSize(new L),s=this.container.clientWidth/this.container.clientHeight,r=n.x/n.z;let a,o;r>s?(a=n.x/.9,o=a/s):(o=n.z/.9,a=o*s),this.camera.left=-a/2,this.camera.right=a/2,this.camera.top=o/2,this.camera.bottom=-o/2,this.camera.zoom=1,this.camera.position.set(t.x,100,t.z),this.camera.lookAt(t.x,0,t.z),this.camera.updateProjectionMatrix(),this.controls.target.set(t.x,0,t.z),this.controls.update()}}function il(i,e,t){return{x:i,y:e,z:t}}function j(i,e){return{x:i,y:0,z:e}}function $n(i,e,t){const n=[],s=e*Math.PI/180;for(let r=0;r<t;r++){const o=r/(t-1)*s;n.push(j(i*Math.sin(o),i*(1-Math.cos(o))))}return n}function yi(i,e,t){return $n(i,e,t).map(s=>j(s.x,-s.z))}function ho(i){const e=i*Math.PI/180;return j(Math.cos(e),Math.sin(e))}function uo(i){const e=i*Math.PI/180;return j(Math.cos(e),-Math.sin(e))}const tv=[{code:"ph",aliases:["placeholder"],sections:[],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[]},{name:"out",position:j(0,0),direction:j(1,0),sectionIndices:[]}]},{code:"str9",aliases:["str"],sections:[{splinePoints:[j(0,0),j(9,0)]}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:j(9,0),direction:j(1,0),sectionIndices:[0]}]},{code:"str6",aliases:[],sections:[{splinePoints:[j(0,0),j(6,0)]}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:j(6,0),direction:j(1,0),sectionIndices:[0]}]},{code:"str3",aliases:[],sections:[{splinePoints:[j(0,0),j(3,0)]}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:j(3,0),direction:j(1,0),sectionIndices:[0]}]},{code:"str15",aliases:[],sections:[{splinePoints:[j(0,0),j(1.5,0)]}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:j(1.5,0),direction:j(1,0),sectionIndices:[0]}]},{code:"crvl18",aliases:[],sections:[{splinePoints:$n(18,22.5,7)}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:$n(18,22.5,7)[6],direction:ho(22.5),sectionIndices:[0]}]},{code:"crvl22",aliases:["crvl","crv"],sections:[{splinePoints:$n(22,22.5,7)}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:$n(22,22.5,7)[6],direction:ho(22.5),sectionIndices:[0]}]},{code:"crvl24",aliases:[],sections:[{splinePoints:$n(24,22.5,7)}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:$n(24,22.5,7)[6],direction:ho(22.5),sectionIndices:[0]}]},{code:"crvr18",aliases:[],sections:[{splinePoints:yi(18,22.5,7)}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:yi(18,22.5,7)[6],direction:uo(22.5),sectionIndices:[0]}]},{code:"crvr22",aliases:["crvr"],sections:[{splinePoints:yi(22,22.5,7)}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:yi(22,22.5,7)[6],direction:uo(22.5),sectionIndices:[0]}]},{code:"crvr24",aliases:[],sections:[{splinePoints:yi(24,22.5,7)}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:yi(24,22.5,7)[6],direction:uo(22.5),sectionIndices:[0]}]},{code:"bump",aliases:["bumper"],sections:[{splinePoints:[j(0,0),j(3,0)]}],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[0]}]},{code:"gen",aliases:["generator"],sections:[{splinePoints:[j(-50,0),j(0,0)]}],connectionPoints:[{name:"in",position:j(-50,0),direction:j(-1,0),sectionIndices:[0]},{name:"out",position:j(0,0),direction:j(1,0),sectionIndices:[0]}]},{code:"bin",aliases:[],sections:[],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[]},{name:"out",position:j(0,0),direction:j(1,0),sectionIndices:[]}]},{code:"tun",aliases:["tunnel"],sections:[],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[]},{name:"out",position:j(0,0),direction:j(1,0),sectionIndices:[]}]},{code:"sem",aliases:["semaphore"],sections:[],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[]},{name:"out",position:j(0,0),direction:j(1,0),sectionIndices:[]}]},{code:"dec",aliases:["decoupler"],sections:[],connectionPoints:[{name:"in",position:j(0,0),direction:j(-1,0),sectionIndices:[]},{name:"out",position:j(0,0),direction:j(1,0),sectionIndices:[]}]},{code:"x90",aliases:[],sections:[{splinePoints:[j(-3,0),j(3,0)]},{splinePoints:[j(0,-3),j(0,3)]}],connectionPoints:[{name:"in1",position:j(-3,0),direction:j(-1,0),sectionIndices:[0]},{name:"out1",position:j(3,0),direction:j(1,0),sectionIndices:[0]},{name:"in2",position:j(0,-3),direction:j(0,-1),sectionIndices:[1]},{name:"out2",position:j(0,3),direction:j(0,1),sectionIndices:[1]}]},{code:"x45",aliases:[],sections:[{splinePoints:[j(-3,0),j(3,0)]},{splinePoints:[j(-2.12,-2.12),j(2.12,2.12)]}],connectionPoints:[{name:"in1",position:j(-3,0),direction:j(-1,0),sectionIndices:[0]},{name:"out1",position:j(3,0),direction:j(1,0),sectionIndices:[0]},{name:"in2",position:j(-2.12,-2.12),direction:j(-.707,-.707),sectionIndices:[1]},{name:"out2",position:j(2.12,2.12),direction:j(.707,.707),sectionIndices:[1]}]}],hh=new Map,uh=new Map;for(const i of tv){hh.set(i.code,i);for(const e of i.aliases)uh.set(e,i)}const dh=new Map;function Zt(i){dh.set(i.code.toLowerCase(),i)}function nt(i){const e=i.toLowerCase(),t=dh.get(e);if(t)return t;const n=hh.get(e)||uh.get(e);if(!n)throw new Error(`Unknown track archetype: ${i}`);return n}const nv=[2972190,3368482,3828522],iv=3832767;let fo=null,po=null;function sv(){return fo||(fo=nv.map(i=>new en({color:i,side:Nt}))),fo}function rv(){return po||(po=new en({color:iv,side:Nt})),po}let mo=null;function fh(){return mo||(mo=new us(1,12)),mo}const _t=4,sl=.3,Ys=.1,ov=2,av=3,cv=20,lv=3;function hv(i,e){var d,f,g,_,p;const t=!!e.treesEnabled,n=!!e.pondEnabled;if(!t&&!n)return;const s=rl(e.pieces);if(!s)return;const r=s.maxX-s.minX,a=s.maxZ-s.minZ,o=r*sl,c=a*sl;s.minX-=o,s.maxX+=o,s.minZ-=c,s.maxZ+=c;const l=Math.max(1,Math.ceil((s.maxX-s.minX)/_t)),h=Math.max(1,Math.ceil((s.maxZ-s.minZ)/_t)),u=[];for(let m=0;m<h;m++)u[m]=new Array(l).fill(-1);if(uv(u,s,e.pieces,l,h),ph(u,l,h),n){const m=(d=e.pondSize)!=null?d:cv,x=(f=e.pondClearance)!=null?f:lv,v=rl(e.pieces),S=v.maxX-v.minX,C=v.maxZ-v.minZ,w={minX:v.minX-S*Ys,maxX:v.maxX+S*Ys,minZ:v.minZ-C*Ys,maxZ:v.maxZ+C*Ys},{group:A,pondCells:U,minOriginalScore:E}=fv(u,s,w,l,h,m,x);i.addSceneryGroup(A);const T=(g=e.pondScore)!=null?g:Math.max(0,E-1);pv(u,l,h,U,T)}if(t){const m=(_=e.treesClearance)!=null?_:ov,x=(p=e.treesDensity)!=null?p:av,v=e.treesFactor,S=dv(u,s,l,h,m,x,v);i.addSceneryGroup(S)}}function rl(i){if(i.length===0)return null;let e=1/0,t=-1/0,n=1/0,s=-1/0;for(const r of i){const a=nt(r.archetypeCode);if(!a)continue;const o=Math.cos(r.rotation),c=Math.sin(r.rotation),l=h=>({x:r.position.x+(h.x*o-h.z*c),z:-(r.position.z+(h.x*c+h.z*o))});for(const h of a.connectionPoints){const u=l(h.position);e=Math.min(e,u.x),t=Math.max(t,u.x),n=Math.min(n,u.z),s=Math.max(s,u.z)}for(const h of a.sections)for(const u of h.splinePoints){const d=l(u);e=Math.min(e,d.x),t=Math.max(t,d.x),n=Math.min(n,d.z),s=Math.max(s,d.z)}}return isFinite(e)?{minX:e,maxX:t,minZ:n,maxZ:s}:null}function ol(i,e,t,n,s){const r=Math.floor((i-t.minX)/_t),a=Math.floor((e-t.minZ)/_t);return r<0||r>=n||a<0||a>=s?null:{col:r,row:a}}function uv(i,e,t,n,s){for(const r of t){if(r.inTunnel)continue;const a=nt(r.archetypeCode);if(!a)continue;const o=Math.cos(r.rotation),c=Math.sin(r.rotation),l=h=>new L(r.position.x+(h.x*o-h.z*c),h.y,-(r.position.z+(h.x*c+h.z*o)));for(const h of a.sections){if(h.splinePoints.length<2)continue;const u=h.splinePoints.map(_=>l(_)),d=new Dn(u),f=d.getLength(),g=Math.max(2,Math.ceil(f));for(let _=0;_<=g;_++){const p=_/g,m=d.getPointAt(p),x=ol(m.x,m.z,e,n,s);x&&(i[x.row][x.col]=0)}}for(const h of a.connectionPoints){const u=l(h.position),d=ol(u.x,u.z,e,n,s);d&&(i[d.row][d.col]=0)}}}function ph(i,e,t){const n=new Map;for(let c=0;c<t;c++)for(let l=0;l<e;l++){const h=i[c][l];h>=0&&(n.has(h)||n.set(h,[]),n.get(h).push([c,l]))}const s=[],r=[...n.keys()].sort((c,l)=>c-l);for(const c of r)s.push(...n.get(c));const a=[[-1,0],[1,0],[0,-1],[0,1]];let o=0;for(;o<s.length;){const[c,l]=s[o++],h=i[c][l];for(const[u,d]of a){const f=c+u,g=l+d;f>=0&&f<t&&g>=0&&g<e&&i[f][g]===-1&&(i[f][g]=h+1,s.push([f,g]))}}}function dv(i,e,t,n,s,r,a){const o=new wt,c=sv(),l=fh();let h=12345;const u=()=>(h=(h*16807+0)%2147483647,(h-1)/2147483646),d=[];for(let p=0;p<n;p++)for(let m=0;m<t;m++){const x=i[p][m];if(x<s)continue;let v;if(a!==void 0){const S=Math.floor(a*x);v=S<=0?0:Math.floor(u()*(S+1))}else v=Math.min(r,x-s+1);for(let S=0;S<v;S++){const C=e.minX+(m+u())*_t,w=e.minZ+(p+u())*_t,A=3+Math.floor(u()*3);for(let U=0;U<A;U++){const E=Math.floor(u()*c.length),T=1+u()*2,B=(u()-.5)*2,X=(u()-.5)*2;d.push({x:C+B,z:w+X,radius:T,materialIndex:E})}}}if(d.length===0)return o;const f=c.map(()=>[]);for(const p of d)f[p.materialIndex].push(p);const g=new vn().setFromEuler(new zi(-Math.PI/2,0,0)),_=new st;for(let p=0;p<c.length;p++){const m=f[p];if(m.length===0)continue;const x=new Ql(l,c[p],m.length);x.frustumCulled=!1;for(let v=0;v<m.length;v++){const{x:S,z:C,radius:w}=m[v];_.compose(new L(S,.005,C),g,new L(w,w,w)),x.setMatrixAt(v,_)}x.instanceMatrix.needsUpdate=!0,o.add(x)}return o}function fv(i,e,t,n,s,r,a){const o=new wt,c=new Set,l=()=>Math.random(),h=[];for(let P=0;P<s;P++)for(let N=0;N<n;N++)if(i[P][N]>=a){const F=e.minX+(N+.5)*_t,$=e.minZ+(P+.5)*_t;F>=t.minX&&F<=t.maxX&&$>=t.minZ&&$<=t.maxZ&&h.push([P,N])}if(h.length===0)return{group:o,pondCells:c,minOriginalScore:0};const u=Math.floor(l()*h.length),[d,f]=h[u],g=new Set,_=[],p=new Set,m=[[-1,0],[1,0],[0,-1],[0,1]];let x=d,v=d,S=f,C=f,w=1/0;const A=(P,N)=>{const F=`${P},${N}`;g.add(F),c.add(F),w=Math.min(w,i[P][N]),x=Math.min(x,P),v=Math.max(v,P),S=Math.min(S,N),C=Math.max(C,N);for(const[$,K]of m){const q=P+$,Z=N+K,ee=`${q},${Z}`;q>=0&&q<s&&Z>=0&&Z<n&&i[q][Z]>=a&&!g.has(ee)&&!p.has(ee)&&(_.push([q,Z]),p.add(ee))}};for(A(d,f);g.size<r&&_.length>0;){const P=Math.floor(l()*_.length),[N,F]=_[P];if(_[P]=_[_.length-1],_.pop(),p.delete(`${N},${F}`),g.has(`${N},${F}`))continue;const $=Math.min(x,N),K=Math.max(v,N),q=Math.min(S,F),Z=Math.max(C,F),ee=K-$+1,V=(Z-q+1)/ee;V<.5||V>2||A(N,F)}if(g.size===0)return{group:o,pondCells:c,minOriginalScore:0};const U=rv(),E=fh(),T=[];for(const P of g){const[N,F]=P.split(",").map(Number),$=e.minX+(F+.5)*_t,K=e.minZ+(N+.5)*_t;T.push({x:$,z:K,radius:_t*1.1});for(const[q,Z]of[[0,1],[1,0]]){const ee=`${N+q},${F+Z}`;g.has(ee)&&T.push({x:$+Z*_t*.5,z:K+q*_t*.5,radius:_t*.9})}for(const[q,Z]of m){const ee=`${N+q},${F+Z}`;if(!g.has(ee))for(let ce=0;ce<3;ce++){const V=(ce-1)*_t*.3,ne=(l()-.5)*_t*.15,_e=Z===0?V+ne:0,Te=q===0?V+ne:0;T.push({x:$+Z*_t*.3+_e,z:K+q*_t*.3+Te,radius:_t*(.5+l()*.25)})}}}if(T.length===0)return{group:o,pondCells:c,minOriginalScore:w};const B=new vn().setFromEuler(new zi(-Math.PI/2,0,0)),X=new st,te=new Ql(E,U,T.length);te.frustumCulled=!1;for(let P=0;P<T.length;P++){const{x:N,z:F,radius:$}=T[P];X.compose(new L(N,.003,F),B,new L($,$,$)),te.setMatrixAt(P,X)}return te.instanceMatrix.needsUpdate=!0,o.add(te),{group:o,pondCells:c,minOriginalScore:w}}function pv(i,e,t,n,s){if(n.size!==0){for(const r of n){const[a,o]=r.split(",").map(Number);i[a][o]=s}for(let r=0;r<t;r++)for(let a=0;a<e;a++){const o=`${r},${a}`;i[r][a]===0||n.has(o)||(i[r][a]=-1)}ph(i,e,t)}}var sn=(i=>(i[i.DEBUG=0]="DEBUG",i[i.INFO=1]="INFO",i[i.WARNING=2]="WARNING",i[i.ERROR=3]="ERROR",i))(sn||{});let Ji=2;function mh(i){Ji=i}const Y={debug(i,...e){Ji<=0&&console.log(`[DEBUG] ${i}`,...e)},info(i,...e){Ji<=1&&console.log(`[INFO] ${i}`,...e)},warn(i,...e){Ji<=2&&console.warn(`[WARN] ${i}`,...e)},error(i,...e){Ji<=3&&console.error(`[ERROR] ${i}`,...e)}},mv=12632264,gv=3022872,_v=5921362,vv=5912624,gh=16777215,xv=16711680,Sv=2271778,Mv=13378082,Ev=4473924,yv=4868682,bv=65280,Tv=16711680,_h=65280,vh=16711680,wv=3355443,xh=16746496,Sh=16711680,Av=1.045,go=.08,Cv=1.45,_o=.15,Rv=.25,Pv=1,Lv=2,Iv=2.64,Zs=.1,Pi=new Map,Ko=new Map,Jo=new Map,Qo=new Map;function Dv(i){Pi.has(i)||Pi.set(i,0);const e=Pi.get(i);return Y.debug(`getSelectedRouteByKey: key="${i}" → ${e}`),e}function Mh(i,e){const t=Pi.get(i);Y.debug(`setSelectedRouteByKey: key="${i}" ${t} → ${e}`),Pi.set(i,e)}function Nv(){return Pi}function Uv(i,e){for(const[t,n]of Ko)if(n.visible=e,e){const s=n.material,r=i.has(t);s.color.setHex(r?xv:gh)}}function Ov(i,e){const t=Jo.get(i);t&&t.dot.material.color.setHex(e?vh:_h)}function al(i,e){const t=Qo.get(i);if(t)for(const n of t)n.material.color.setHex(e?Sh:xh)}function Gi(i,e,t=!1){var r;t?i.clearTrack():i.clearLayout(),Ko.clear(),Jo.clear(),Qo.clear();const n=new Map;for(const a of e.pieces)n.set(a.id,a);const s=(r=e.randomSwitches)!=null?r:!1;for(const a of e.pieces){const o=nt(a.archetypeCode),c=Fv(a,o,n,s);if(i.addTrackGroup(c),a.label){const l=Wv(a,o),h=2,u=Math.cos(a.rotation+Math.PI/2)*h,d=-Math.sin(a.rotation+Math.PI/2)*h;i.addLabel(a.label,l.x+u,l.z+d)}}t||hv(i,e),i.fitToLayout(),i.render()}function Fv(i,e,t,n=!1){var h,u,d,f;const s=new wt,r=Math.cos(i.rotation),a=Math.sin(i.rotation),o=g=>new L(i.position.x+(g.x*r-g.z*a),g.y,-(i.position.z+(g.x*a+g.z*r))),l=e.code==="gen"||e.code==="bin"||i.inTunnel;if(!l){for(const g of e.sections)if(g.splinePoints.length>=2){const _=g.splinePoints.map(m=>o(m)),p=zv(_);s.add(p)}}if(!l){for(const g of e.connectionPoints){const _=o({x:g.position.x,y:0,z:g.position.z}),p=`${i.id}.${g.name}`,m=i.connections.get(g.name)||[],x=ll(_,p);if(s.add(x),Y.debug(`  ${i.id}.${g.name}: ${m.length} connections`),m.length>1&&!n){const v=Kv(i,g.name,_,m,t);for(const S of v)s.add(S)}}if(i.internalConnectionPoints)for(const g of i.internalConnectionPoints){const _=new L(g.worldPosition.x,0,-g.worldPosition.z),p=ll(_,g.id);s.add(p),Y.debug(`  Internal connection point ${g.id} at (${g.worldPosition.x.toFixed(1)}, ${g.worldPosition.z.toFixed(1)})`)}}if(e.code==="gen"){const g=o({x:0,y:0,z:0}),_=Bv(g);_.userData={isGenerator:!0,pieceId:i.id},s.add(_)}else if(e.code==="bin"){const g=o({x:0,y:0,z:0}),_=kv(g);s.add(_)}else if(e.code==="bump"||e.code==="bumper"){const g=$v(i,e,o);s.add(g)}else if(e.code==="tun"||e.code==="tunnel"){const g=Vv(i);for(const _ of g)s.add(_)}else if(e.code==="sem"||e.code==="semaphore"){const g=o({x:0,y:0,z:0}),_=(u=(h=i.semaphoreConfig)==null?void 0:h.locked)!=null?u:!1,p=Gv(g,i.id,_);s.add(p)}else if(e.code==="dec"||e.code==="decoupler"){const g=o({x:0,y:0,z:0}),_=(f=(d=i.decouplerConfig)==null?void 0:d.activated)!=null?f:!1,p=Hv(g,i.id,i.rotation,_);s.add(p)}return s}function zv(i){const e=new wt,t=new Dn(i),n=t.getLength(),s=Math.max(16,i.length*8),r=new Cn({color:mv,roughness:.2,metalness:.85,envMapIntensity:1}),a=new Cn({color:gv,roughness:.9,metalness:0}),o=new Cn({color:_v,roughness:1,metalness:0}),c=new Cn({color:vv,roughness:.9,metalness:0}),l=cl(t,s,Iv,Zs),h=new tt(l,c);h.position.y=.01,e.add(h);const u=cl(t,s,Lv,.08),d=new tt(u,o);d.position.y=Zs+.02,e.add(d);const f=new si(Rv,_o,Cv),g=Math.floor(n/Pv);for(let T=0;T<=g;T++){const B=T/Math.max(g,1),X=t.getPointAt(B),te=t.getTangentAt(B),P=new tt(f,a);P.position.set(X.x,Zs+.08+_o/2,X.z);const N=Math.atan2(-te.z,te.x);P.rotation.y=N,e.add(P)}const _=Av/2,p=[],m=[],x=s;for(let T=0;T<=x;T++){const B=T/x,X=t.getPointAt(B),te=t.getTangentAt(B),P=-te.z,N=te.x;p.push(new L(X.x+P*_,X.y,X.z+N*_)),m.push(new L(X.x-P*_,X.y,X.z-N*_))}const v=new Dn(p),S=new Dn(m),C=new ur(v,s,go,6,!1),w=new ur(S,s,go,6,!1),A=new tt(C,r),U=new tt(w,r),E=Zs+.08+_o+go;return A.position.y=E,U.position.y=E,e.add(A),e.add(U),e}function cl(i,e,t,n){const s=t/2,r=[],a=[];for(let c=0;c<=e;c++){const l=c/e,h=i.getPointAt(l),u=i.getTangentAt(l),d=-u.z,f=u.x;r.push(h.x+d*s,0,h.z+f*s),r.push(h.x-d*s,0,h.z-f*s),r.push(h.x-d*s,n,h.z-f*s),r.push(h.x+d*s,n,h.z+f*s)}for(let c=0;c<e;c++){const l=c*4;a.push(l+3,l+2,l+6),a.push(l+3,l+6,l+7),a.push(l+0,l+3,l+7),a.push(l+0,l+7,l+4),a.push(l+2,l+1,l+5),a.push(l+2,l+5,l+6),a.push(l+0,l+4,l+5),a.push(l+0,l+5,l+1)}const o=new Lt;return o.setAttribute("position",new rt(r,3)),o.setIndex(a),o.computeVertexNormals(),o}function ll(i,e){const t=new fs(.25,16,16),n=new en({color:gh}),s=new tt(t,n);return s.position.set(i.x,.5,i.z),s.visible=!1,Ko.set(e,s),s}function Bv(i){const e=new us(1.5,32),t=new en({color:Sv,side:Nt}),n=new tt(e,t);return n.rotation.x=-Math.PI/2,n.position.set(i.x,.6,i.z),n}function kv(i){const e=new us(1.5,32),t=new en({color:Mv,side:Nt}),n=new tt(e,t);return n.rotation.x=-Math.PI/2,n.position.set(i.x,.5,i.z),n}function Gv(i,e,t){const n=new wt,s=new Yo(1.3,1.5,32),r=new en({color:wv,side:Nt}),a=new tt(s,r);a.rotation.x=-Math.PI/2,a.position.set(i.x,.55,i.z),n.add(a);const o=new fs(.6,16,16),c=t?vh:_h,l=new en({color:c}),h=new tt(o,l);return h.position.set(i.x,.7,i.z),h.userData={isSemaphore:!0,pieceId:e},n.add(h),Jo.set(e,{dot:h,ring:a}),n}function Hv(i,e,t,n){const s=new wt,r=n?Sh:xh,a=1.13,o=1.5,c=-Math.sin(-t),l=-Math.cos(-t),h=new ki;h.moveTo(0,a),h.lineTo(-a*.7,-a*.5),h.lineTo(a*.7,-a*.5),h.lineTo(0,a);const u=new Zo(h),d=new en({color:r,side:Nt}),f=new tt(u,d.clone());f.rotation.x=-Math.PI/2,f.rotation.z=-t,f.position.set(i.x+c*o,.6,i.z+l*o),f.userData={isDecoupler:!0,pieceId:e},s.add(f);const g=new tt(u,d.clone());return g.rotation.x=-Math.PI/2,g.rotation.z=Math.PI-t,g.position.set(i.x-c*o,.6,i.z-l*o),g.userData={isDecoupler:!0,pieceId:e},s.add(g),Qo.set(e,[f,g]),s}function Vv(i){const e=[],a=new Cn({color:yv,roughness:.7,metalness:.2}),c=(()=>{const u=new ki,d=4.2/2,f=.3;u.moveTo(-d,0),u.lineTo(-d,.8),u.lineTo(-d+f,.8),u.lineTo(-d+f,f),u.lineTo(d-f,f),u.lineTo(d-f,.8),u.lineTo(d,.8),u.lineTo(d,0),u.lineTo(-d,0);const g={depth:1.5,bevelEnabled:!1};return new ds(u,g)})(),l=new tt(c,a);l.rotation.order="YXZ",l.rotation.y=Math.PI/2,l.rotation.x=-Math.PI/2,l.rotation.z=Math.PI+i.rotation,l.position.set(i.position.x,0,-i.position.z),e.push(l);const h=new tt(c,a);return h.rotation.order="YXZ",h.rotation.y=Math.PI/2,h.rotation.x=-Math.PI/2,h.rotation.z=i.rotation,h.position.set(i.position.x,0,-i.position.z),e.push(h),e}function Wv(i,e){const t=Math.cos(i.rotation),n=Math.sin(i.rotation),s=o=>({x:i.position.x+(o.x*t-o.z*n),z:-(i.position.z+(o.x*n+o.z*t))}),r=e.connectionPoints.find(o=>o.name==="in"),a=e.connectionPoints.find(o=>o.name==="out");if(r&&a){const o=s(r.position),c=s(a.position);return{x:(o.x+c.x)/2,z:(o.z+c.z)/2}}if(e.sections.length>0&&e.sections[0].splinePoints.length>0){const o=e.sections[0].splinePoints,c=Math.floor(o.length/2);return s(o[c])}return{x:i.position.x,z:-i.position.z}}function $v(i,e,t){const n=e.sections[0];let s,r=i.rotation;if(!n||n.splinePoints.length<2)s=t({x:0,y:0,z:0});else{const l=n.splinePoints[n.splinePoints.length-1];s=t(l);const h=n.splinePoints[n.splinePoints.length-2],u=n.splinePoints[n.splinePoints.length-1],d={x:u.x-h.x,z:u.z-h.z},f=Math.cos(i.rotation),g=Math.sin(i.rotation),_={x:d.x*f-d.z*g,z:-(d.x*g+d.z*f)};r=Math.atan2(_.z,_.x)}const a=new si(.5,1,2),o=new Cn({color:Ev}),c=new tt(a,o);return c.position.set(s.x,.5,s.z),c.rotation.y=r,c}const Xv=30,qv=.4,Yv=1,Zv=.75;function jv(i){return i==="in"||i==="in1"||i==="in2"}function Kv(i,e,t,n,s){const r=[];if(n.length>1){const a=jv(e)?"bwd":"fwd",o=Jv(i,e,a,n,s,n);r.push(...o)}return r}function Jv(i,e,t,n,s,r){const a=[],o=r.map(g=>`${g.pieceId}.${g.pointName}`);o.push(`${i.id}.${e}`),o.sort();const l=`junction.${o[0]}.${t}`,h=Dv(l);Y.debug(`renderSwitchIndicators: ${l}, ${n.length} connections, selectedIndex=${h}`),n.forEach((g,_)=>Y.debug(`  route[${_}]: ${g.pieceId}.${g.pointName} ${g.isAutoConnect?"(auto)":""}`));const u=[];for(const g of n){const _=Qv(g,s);u.push(_)}const d=u.map(g=>{if(!g)return null;const _=nx(g);return ex(g,_)});if(d.filter(g=>g!==null).length<=1)return a;for(let g=0;g<n.length;g++){const _=d[g];if(Y.debug(`  Indicator ${g}: pos=${_?`(${_.x.toFixed(2)}, ${_.z.toFixed(2)})`:"null"}, curveInfo=${u[g]?"valid":"null"}`),!_)continue;const p=g===h,m=p?bv:Tv,x=new fs(.6,16,16),v=new en({color:m}),S=new tt(x,v);S.position.set(_.x,.7,_.z),S.userData={isSwitchIndicator:!0,routeKey:l,connectionIndex:g},Y.debug(`  Created indicator ${g} at (${_.x.toFixed(2)}, 0.7, ${_.z.toFixed(2)}), selected=${p}, color=${p?"green":"red"}`),a.push(S)}return a}function hl(i){return i==="in"?"out":i==="out"?"in":i==="in1"?"out1":i==="out1"?"in1":i==="in2"?"out2":i==="out2"?"in2":"out"}function Qv(i,e){const t=e.get(i.pieceId);if(!t)return null;const n=nt(t.archetypeCode);if(!n||n.sections.length===0)return null;const s=n.sections[0];if(s.splinePoints.length<2)return null;const r=Math.cos(t.rotation),a=Math.sin(t.rotation),o=p=>new L(t.position.x+(p.x*r-p.z*a),p.y,-(t.position.z+(p.x*a+p.z*r))),c=s.splinePoints.map(p=>o(p)),l=new Dn(c),h=l.getLength();if(h===0)return null;const u=i.pointName==="in"||i.pointName==="in1",d=hl(i.pointName),f=t.connections.get(d)||[],g=f.length>1;let _=!1;if(f.length===1){const p=f[0],m=e.get(p.pieceId);if(m){const x=hl(p.pointName),v=m.connections.get(x)||[];if(v.length>1)_=!0;else if(v.length===1){const S=v[0],C=e.get(S.pieceId);C&&(_=(C.connections.get(S.pointName)||[]).length>1)}}}return{curve:l,curveLength:h,isFromIn:u,farEndHasSwitch:g,farEndNextTrackHasSwitch:_}}function ex(i,e){const t=i.isFromIn?Math.min(e/i.curveLength,1):Math.max(1-e/i.curveLength,0),n=i.curve.getPointAt(t);return{x:n.x,z:n.z}}function tx(i){return i.farEndHasSwitch?qv:i.farEndNextTrackHasSwitch?Zv:Yv}function nx(i){const e=tx(i);return Math.min(i.curveLength*e,Xv)}const er=4,tr=3,vo=.5;function Rn(i,e){const t=nt(i.archetypeCode);if(!t||e>=t.sections.length)return 0;const n=t.sections[e];if(n.splinePoints.length<2)return 0;const s=Eh(n.splinePoints,i);return new Dn(s).getLength()}function Eh(i,e){const t=Math.cos(e.rotation),n=Math.sin(e.rotation);return i.map(s=>new L(e.position.x+(s.x*t-s.z*n),s.y,e.position.z+(s.x*n+s.z*t)))}function ix(i,e,t){const n=nt(i.archetypeCode);if(!n||e>=n.sections.length)return null;const s=n.sections[e];if(s.splinePoints.length<2)return{position:{x:i.position.x,y:0,z:i.position.z},rotation:i.rotation};const r=Eh(s.splinePoints,i),a=new Dn(r),o=a.getLength();if(o===0)return{position:{x:i.position.x,y:0,z:i.position.z},rotation:i.rotation};const c=Math.max(0,Math.min(1,t/o)),l=a.getPointAt(c),h=a.getTangentAt(c),u=Math.atan2(h.z,h.x);return{position:{x:l.x,y:0,z:l.z},rotation:u}}function zo(i,e){const t=e.pieces.find(r=>r.id===i.currentPieceId);if(!t)return;const n=Qi(i.entryPoint),s=ix(t,n,i.distanceAlongSection);s&&(i.worldPosition=s.position,i.rotation=s.rotation+(i.sectionDirection===-1?Math.PI:0))}function ni(i){return i==="in"||i==="in1"||i==="in2"}function dr(i){return i==="out"||i==="out1"||i==="out2"}function Qi(i){return i&&(i==="in2"||i==="out2")?1:0}function xo(i,e){return dr(i)&&dr(e)||ni(i)&&ni(e)}function nr(i,e,t,n,s,r,a,o){var x;const c=t.pieces.find(v=>v.id===i);if(!c)return null;const l=c.connections.get(e);if(!l||l.length===0)return null;const h=l.filter(v=>v.pieceId!==r);if(h.length===0)return null;if(h.length===1)return{pieceId:h[0].pieceId,entryPoint:h[0].pointName};const u=h,d=a==="backward"?"bwd":"fwd",f=l.map(v=>`${v.pieceId}.${v.pointName}`);f.push(`${i}.${e}`),f.sort();const _=`junction.${f[0]}.${d}`;let p;s!=null&&s.has(_)?(p=s.get(_),o&&o.add(_)):(t.randomSwitches?p=Math.floor(Math.random()*u.length):p=(x=n.get(_))!=null?x:0,s&&s.set(_,p));const m=u[Math.min(p,u.length-1)];return{pieceId:m.pieceId,entryPoint:m.pointName}}function ea(i){return i==="in"?"out":i==="out"?"in":i==="in1"?"out1":i==="out1"?"in1":i==="in2"?"out2":i==="out2"?"in2":"out"}function sx(i,e,t,n,s,r){i.distanceAlongSection+=e*i.sectionDirection;let a=t.pieces.find(h=>h.id===i.currentPieceId);if(!a)return;let o=Qi(i.entryPoint),c=Rn(a,o),l=0;for(;c===0&&l<10;){l++;let h,u;i.entryPoint?(h=ea(i.entryPoint),u=ni(i.entryPoint)?"forward":"backward"):(h=i.distanceAlongSection>=0?"out":"in",u="forward");const d=nr(i.currentPieceId,h,t,n,s,i.previousPieceId,u,r);if(!d){i.distanceAlongSection=0,zo(i,t);return}if(xo(h,d.entryPoint)&&(i.sectionDirection=i.sectionDirection===1?-1:1),i.previousPieceId=i.currentPieceId,i.currentPieceId=d.pieceId,i.entryPoint=d.entryPoint,a=t.pieces.find(f=>f.id===i.currentPieceId),!a)return;o=Qi(i.entryPoint),c=Rn(a,o)}for(;i.distanceAlongSection>=c&&c>0;){const h=i.distanceAlongSection-c,u="out",d=nr(i.currentPieceId,u,t,n,s,i.previousPieceId,"forward",r);if(!d){i.distanceAlongSection=c;return}xo(u,d.entryPoint)&&(i.sectionDirection=i.sectionDirection===1?-1:1),i.previousPieceId=i.currentPieceId,i.currentPieceId=d.pieceId,i.entryPoint=d.entryPoint;const f=t.pieces.find(g=>g.id===d.pieceId);if(f){const g=Qi(d.entryPoint),_=Rn(f,g);dr(d.entryPoint)?i.distanceAlongSection=_-h:i.distanceAlongSection=h,c=_}else{i.distanceAlongSection=h;break}}for(;i.distanceAlongSection<0&&c>0;){const h="in",u=nr(i.currentPieceId,h,t,n,s,i.previousPieceId,"backward",r);if(!u){i.distanceAlongSection=0;break}const d=t.pieces.find(f=>f.id===u.pieceId);if(d){const f=Qi(u.entryPoint),g=Rn(d,f);if(g===0){i.distanceAlongSection=0;break}xo(h,u.entryPoint)&&(i.sectionDirection=i.sectionDirection===1?-1:1);const _=-i.distanceAlongSection;i.previousPieceId=i.currentPieceId,i.currentPieceId=u.pieceId,i.entryPoint=u.entryPoint,ni(u.entryPoint)?i.distanceAlongSection=_:i.distanceAlongSection=g-_,c=g}else break}zo(i,t)}const yh=2,fr=1.5,rx=16776960,bh=[16711680,255,65280,16711935,16776960],ox=[3158064,5263440,7368816,9474192,11579568];let es=null;function ax(i="gray"){if(i==="black")return 0;const e=i==="colorful"?bh:ox,t=e.map((r,a)=>es!==null&&a===es?2:1),n=t.reduce((r,a)=>r+a,0);let s=Math.random()*n;for(let r=0;r<t.length;r++)if(s-=t[r],s<=0)return es=r,e[r];return es=0,e[0]}function cx(){es=null}function lx(){const i=er/2,e=yh/2,t=.25,n=.15,s=i*.35,r=e*.35,a=.15,o=new ki;return o.moveTo(-i+t,-e),o.quadraticCurveTo(-i,-e,-i,-e+t),o.lineTo(-i,e-t),o.quadraticCurveTo(-i,e,-i+t,e),o.lineTo(s,e),o.lineTo(i-a,r+n),o.quadraticCurveTo(i-a+n*.5,r,i,r),o.lineTo(i,-r),o.quadraticCurveTo(i-a+n*.5,-r,i-a,-r-n),o.lineTo(s,-e),o.lineTo(-i+t,-e),o}function hx(){const i=tr/2,e=yh/2,t=.2,n=new ki;return n.moveTo(-i+t,-e),n.quadraticCurveTo(-i,-e,-i,-e+t),n.lineTo(-i,e-t),n.quadraticCurveTo(-i,e,-i+t,e),n.lineTo(i-t,e),n.quadraticCurveTo(i,e,i,e-t),n.lineTo(i,-e+t),n.quadraticCurveTo(i,-e,i-t,-e),n.lineTo(-i+t,-e),n}let ji=null,Ki=null,So=null,Mo=null;const ul=new Map;let Eo=null;function Th(){if(!ji){const i=lx();ji=new ds(i,{depth:fr,bevelEnabled:!1}),ji.rotateX(-Math.PI/2),ji.translate(0,fr/2,0)}return ji}function wh(){if(!Ki){const i=hx();Ki=new ds(i,{depth:fr,bevelEnabled:!1}),Ki.rotateX(-Math.PI/2),Ki.translate(0,fr/2,0)}return Ki}function ux(){return So||(So=new oh(Th(),15)),So}function dx(){return Mo||(Mo=new oh(wh(),15)),Mo}function fx(i){let e=ul.get(i);return e||(e=new Cn({color:i,roughness:.5,metalness:.1}),ul.set(i,e)),e}function px(){return Eo||(Eo=new eh({color:0,linewidth:1})),Eo}function mx(i){const e=new wt;for(const t of i){const n=gx(t);e.add(n)}return e}function gx(i){const e=new wt;e.name=i.id;for(const t of i.cars){const n=_x(t);e.add(n)}return e}function _x(i){var d;const e=i.type==="cab",t=e?Th():wh(),n=e?ux():dx(),s=e?rx:(d=i.color)!=null?d:bh[0],r=fx(s),a=new tt(t,r),o=new u_(n,px()),c=new wt;c.name=i.id,c.add(a),c.add(o);const l=i.worldPosition.x,h=-i.worldPosition.z,u=i.rotation;return Number.isNaN(l)||Number.isNaN(h)||Number.isNaN(u)?(Y.error(`NaN detected in car ${i.id}: pos=(${l}, ${h}), rot=${u}`),c.visible=!1):(c.position.set(l,0,h),c.rotation.y=u),c.visible=i.visible,c}var k=(i=>(i.IDENTIFIER="IDENTIFIER",i.LABEL_DEF="LABEL_DEF",i.LABEL_REF="LABEL_REF",i.DOT="DOT",i.REPETITION="REPETITION",i.NUMBER="NUMBER",i.RANGE="RANGE",i.STRING="STRING",i.NEW="NEW",i.LOOP_CLOSE="LOOP_CLOSE",i.TITLE="TITLE",i.DESCRIPTION="DESCRIPTION",i.LOCKAHEAD="LOCKAHEAD",i.DISTANCE="DISTANCE",i.COUNT="COUNT",i.DEGREES="DEGREES",i.OFFSET="OFFSET",i.BASE="BASE",i.SPLICE="SPLICE",i.USING="USING",i.CABS="CABS",i.CARS="CARS",i.SPEED="SPEED",i.EVERY="EVERY",i.COLORFUL="COLORFUL",i.GRAY="GRAY",i.BLACK="BLACK",i.RANDOM="RANDOM",i.MAX="MAX",i.TRAINS="TRAINS",i.FLEX="FLEX",i.CONNECT="CONNECT",i.CROSS="CROSS",i.DEFINE="DEFINE",i.LEFT="LEFT",i.RIGHT="RIGHT",i.STRAIGHT="STRAIGHT",i.RADIUS="RADIUS",i.ARC="ARC",i.LENGTH="LENGTH",i.ARRAY="ARRAY",i.ANGLE="ANGLE",i.PREFIX="PREFIX",i.LOG="LOG",i.PREFAB="PREFAB",i.USE="USE",i.TREES="TREES",i.CLEARANCE="CLEARANCE",i.DENSITY="DENSITY",i.FACTOR="FACTOR",i.NONE="NONE",i.POND="POND",i.SIZE="SIZE",i.SCORE="SCORE",i.EOF="EOF",i))(k||{});function vx(i){const e=[],t=i.split(`
