var zh=Object.defineProperty;var Bh=(i,e,t)=>e in i?zh(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var pe=(i,e,t)=>Bh(i,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const kh=`title Example: Array
...
flex connect $main  $side
                                                                                                                                             `,Gh=`title Example: Cross Connect
...
`,qh=`title Layout: Four Tracks Spiraling
...
crvr27
> $p1_3.in;
`,Yh=`title Layout: More loops and switches
...
# crvl
# str * 2 
# bin`,Zh=`title         Layout: Two simple loops
...
void main() {
	...
	`}function _m(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===wo||c===Ao,h=c===Pi||c===Li;if(l||h)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let u=e.get(o);return t===null&&(t=new Do(i)),u=l?t.fromEquirectangular(o,u):t.fromCubemap(o,u),e.set(o,u),u.texture}else{if(e.has(o))return e.get(o).texture;{const u=o.image;if(l&&u&&u.height>0||h&&u&&s(u)){t===null&&(t=new Do(i));const d=l?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,d),o.addEventListener("dispose",r),d.texture}else return null}}}return o}function s(o){let c=0;const l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function vm(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const s=t(n);return s===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function xm(i,e,t,n){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)e.remove(_[p])}d.removeEventListener("dispose",a),delete s[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let p=0,m=_.length;p<m;p++)e.update(_[p],i.ARRAY_BUFFER)}}function l(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const x=f.array;_=f.version;for(let v=0,S=x.length;v<S;v+=3){const C=x[v+0],A=x[v+1],w=x[v+2];d.push(C,A,A,w,w,C)}}else if(g!==void 0){const x=g.array;_=g.version;for(let v=0,S=x.length/3-1;v<S;v+=3){const C=v+0,A=v+1,w=v+2;d.push(C,A,A,w,w,C)}}else return;const p=new(Ul(d)?Gl:kl)(d,1);p.version=_;const m=r.get(u);m&&e.remove(m),r.set(u,p)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function Sm(i,e,t,n){const s=n.isWebGL2;let r;function a(f){r=f}let o,c;function l(f){o=f.type,c=f.bytesPerElement}function h(f,g){i.drawElements(r,g,o,f*c),t.update(g,r,1)}function u(f,g,_){if(_===0)return;let p,m;if(s)p=i,m="drawElementsInstanced";else if(p=e.get("ANGLE_instanced_arrays"),m="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[m](r,g,o,f*c,_),t.update(g,r,_)}function d(f,g,_){if(_===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<_;m++)this.render(f[m]/c,g[m]);else{p.multiDrawElementsWEBGL(r,g,0,o,f,0,_);let m=0;for(let x=0;x<_;x++)m+=g[x];t.update(m,r,1)}}this.setMode=a,this.setIndex=l,this.render=h,this.renderInstances=u,this.renderMultiDraw=d}function Mm(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Em(i,e){return i[0]-e[0]}function ym(i,e){return Math.abs(e[1])-Math.abs(i[1])}function bm(i,e,t){const n={},s=new Float32Array(8),r=new WeakMap,a=new yt,o=[];for(let l=0;l<8;l++)o[l]=[l,0];function c(l,h,u){const d=l.morphTargetInfluences;if(e.isWebGL2===!0){const g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=g!==void 0?g.length:0;let p=r.get(h);if(p===void 0||p.count!==_){let U=function(){ee.dispose(),r.delete(h),h.removeEventListener("dispose",U)};var f=U;p!==void 0&&p.texture.dispose();const v=h.morphAttributes.position!==void 0,S=h.morphAttributes.normal!==void 0,C=h.morphAttributes.color!==void 0,A=h.morphAttributes.position||[],w=h.morphAttributes.normal||[],N=h.morphAttributes.color||[];let E=0;v===!0&&(E=1),S===!0&&(E=2),C===!0&&(E=3);let b=h.attributes.position.count*E,F=1;b>e.maxTextureSize&&(F=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);const $=new Float32Array(b*F*4*_),ee=new zl($,b,F,_);ee.type=An,ee.needsUpdate=!0;const P=E*4;for(let O=0;O<_;O++){const X=A[O],q=w[O],K=N[O],j=b*F*4*O;for(let te=0;te<X.count;te++){const ae=te*P;v===!0&&(a.fromBufferAttribute(X,te),$[j+ae+0]=a.x,$[j+ae+1]=a.y,$[j+ae+2]=a.z,$[j+ae+3]=0),S===!0&&(a.fromBufferAttribute(q,te),$[j+ae+4]=a.x,$[j+ae+5]=a.y,$[j+ae+6]=a.z,$[j+ae+7]=0),C===!0&&(a.fromBufferAttribute(K,te),$[j+ae+8]=a.x,$[j+ae+9]=a.y,$[j+ae+10]=a.z,$[j+ae+11]=K.itemSize===4?a.w:1)}}p={count:_,texture:ee,size:new le(b,F)},r.set(h,p),h.addEventListener("dispose",U)}let m=0;for(let v=0;v<d.length;v++)m+=d[v];const x=h.morphTargetsRelative?1:1-m;u.getUniforms().setValue(i,"morphTargetBaseInfluence",x),u.getUniforms().setValue(i,"morphTargetInfluences",d),u.getUniforms().setValue(i,"morphTargetsTexture",p.texture,t),u.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}else{const g=d===void 0?0:d.length;let _=n[h.id];if(_===void 0||_.length!==g){_=[];for(let S=0;S<g;S++)_[S]=[S,0];n[h.id]=_}for(let S=0;S<g;S++){const C=_[S];C[0]=S,C[1]=d[S]}_.sort(ym);for(let S=0;S<8;S++)S<g&&_[S][1]?(o[S][0]=_[S][0],o[S][1]=_[S][1]):(o[S][0]=Number.MAX_SAFE_INTEGER,o[S][1]=0);o.sort(Em);const p=h.morphAttributes.position,m=h.morphAttributes.normal;let x=0;for(let S=0;S<8;S++){const C=o[S],A=C[0],w=C[1];A!==Number.MAX_SAFE_INTEGER&&w?(p&&h.getAttribute("morphTarget"+S)!==p[A]&&h.setAttribute("morphTarget"+S,p[A]),m&&h.getAttribute("morphNormal"+S)!==m[A]&&h.setAttribute("morphNormal"+S,m[A]),s[S]=w,x+=w):(p&&h.hasAttribute("morphTarget"+S)===!0&&h.deleteAttribute("morphTarget"+S),m&&h.hasAttribute("morphNormal"+S)===!0&&h.deleteAttribute("morphNormal"+S),s[S]=0)}const v=h.morphTargetsRelative?1:1-x;u.getUniforms().setValue(i,"morphTargetBaseInfluence",v),u.getUniforms().setValue(i,"morphTargetInfluences",s)}}return{update:c}}function Tm(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(s.get(u)!==l&&(e.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function a(){s=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}class Xl extends Ft{constructor(e,t,n,s,r,a,o,c,l,h){if(h=h!==void 0?h:Kn,h!==Kn&&h!==Ii)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Kn&&(n=wn),n===void 0&&h===Ii&&(n=jn),super(null,s,r,a,o,c,h,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Dt,this.minFilter=c!==void 0?c:Dt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const ql=new Ft,Yl=new Xl(1,1);Yl.compareFunction=Nl;const Zl=new zl,jl=new cd,Kl=new Wl,_c=[],vc=[],xc=new Float32Array(16),Sc=new Float32Array(9),Mc=new Float32Array(4);function zi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=_c[s];if(r===void 0&&(r=new Float32Array(s),_c[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function xt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function St(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function xr(i,e){let t=vc[e];t===void 0&&(t=new Int32Array(e),vc[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function wm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Am(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2fv(this.addr,e),St(t,e)}}function Cm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(xt(t,e))return;i.uniform3fv(this.addr,e),St(t,e)}}function Rm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4fv(this.addr,e),St(t,e)}}function Pm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),St(t,e)}else{if(xt(t,n))return;Mc.set(n),i.uniformMatrix2fv(this.addr,!1,Mc),St(t,n)}}function Lm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),St(t,e)}else{if(xt(t,n))return;Sc.set(n),i.uniformMatrix3fv(this.addr,!1,Sc),St(t,n)}}function Im(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),St(t,e)}else{if(xt(t,n))return;xc.set(n),i.uniformMatrix4fv(this.addr,!1,xc),St(t,n)}}function Dm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Nm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2iv(this.addr,e),St(t,e)}}function Um(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;i.uniform3iv(this.addr,e),St(t,e)}}function Om(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4iv(this.addr,e),St(t,e)}}function Fm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function zm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2uiv(this.addr,e),St(t,e)}}function Bm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;i.uniform3uiv(this.addr,e),St(t,e)}}function km(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4uiv(this.addr,e),St(t,e)}}function Gm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);const r=this.type===i.SAMPLER_2D_SHADOW?Yl:ql;t.setTexture2D(e||r,s)}function Hm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||jl,s)}function Vm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Kl,s)}function Wm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Zl,s)}function $m(i){switch(i){case 5126:return wm;case 35664:return Am;case 35665:return Cm;case 35666:return Rm;case 35674:return Pm;case 35675:return Lm;case 35676:return Im;case 5124:case 35670:return Dm;case 35667:case 35671:return Nm;case 35668:case 35672:return Um;case 35669:case 35673:return Om;case 5125:return Fm;case 36294:return zm;case 36295:return Bm;case 36296:return km;case 35678:case 36198:case 36298:case 36306:case 35682:return Gm;case 35679:case 36299:case 36307:return Hm;case 35680:case 36300:case 36308:case 36293:return Vm;case 36289:case 36303:case 36311:case 36292:return Wm}}function Xm(i,e){i.uniform1fv(this.addr,e)}function qm(i,e){const t=zi(e,this.size,2);i.uniform2fv(this.addr,t)}function Ym(i,e){const t=zi(e,this.size,3);i.uniform3fv(this.addr,t)}function Zm(i,e){const t=zi(e,this.size,4);i.uniform4fv(this.addr,t)}function jm(i,e){const t=zi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Km(i,e){const t=zi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Jm(i,e){const t=zi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Qm(i,e){i.uniform1iv(this.addr,e)}function eg(i,e){i.uniform2iv(this.addr,e)}function tg(i,e){i.uniform3iv(this.addr,e)}function ng(i,e){i.uniform4iv(this.addr,e)}function ig(i,e){i.uniform1uiv(this.addr,e)}function sg(i,e){i.uniform2uiv(this.addr,e)}function rg(i,e){i.uniform3uiv(this.addr,e)}function og(i,e){i.uniform4uiv(this.addr,e)}function ag(i,e,t){const n=this.cache,s=e.length,r=xr(t,s);xt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||ql,r[a])}function cg(i,e,t){const n=this.cache,s=e.length,r=xr(t,s);xt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||jl,r[a])}function lg(i,e,t){const n=this.cache,s=e.length,r=xr(t,s);xt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Kl,r[a])}function hg(i,e,t){const n=this.cache,s=e.length,r=xr(t,s);xt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Zl,r[a])}function ug(i){switch(i){case 5126:return Xm;case 35664:return qm;case 35665:return Ym;case 35666:return Zm;case 35674:return jm;case 35675:return Km;case 35676:return Jm;case 5124:case 35670:return Qm;case 35667:case 35671:return eg;case 35668:case 35672:return tg;case 35669:case 35673:return ng;case 5125:return ig;case 36294:return sg;case 36295:return rg;case 36296:return og;case 35678:case 36198:case 36298:case 36306:case 35682:return ag;case 35679:case 36299:case 36307:return cg;case 35680:case 36300:case 36308:case 36293:return lg;case 36289:case 36303:case 36311:case 36292:return hg}}class dg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=$m(t.type)}}class fg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=ug(t.type)}}class pg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const eo=/(\w+)(\])?(\[|\.)?/g;function Ec(i,e){i.seq.push(e),i.map[e.id]=e}function mg(i,e,t){const n=i.name,s=n.length;for(eo.lastIndex=0;;){const r=eo.exec(n),a=eo.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Ec(t,l===void 0?new dg(o,i,e):new fg(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new pg(o),Ec(t,u)),t=u}}}class Qs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);mg(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function yc(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const gg=37297;let _g=0;function vg(i,e){const t=i.split(`
...
`+vg(i.getShaderSource(e),a)}else return s}function Sg(i,e){const t=xg(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Mg(i,e){let t;switch(e){case Pu:t="Linear";break;case Lu:t="Reinhard";break;case Iu:t="OptimizedCineon";break;case Du:t="ACESFilmic";break;case Uu:t="AgX";break;case Nu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Eg(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Ti).join(`
`)}function yg(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Ti).join(`
`)}function bg(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Tg(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ti(i){return i!==""}function Tc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function wc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const wg=/^[ \t]*#include +<([\w\d./]+)>/gm;function No(i){return i.replace(wg,Cg)}const Ag=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Cg(i,e){let t=We[e];if(t===void 0){const n=Ag.get(e);if(n!==void 0)t=We[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return No(t)}const Rg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ac(i){return i.replace(Rg,Pg)}function Pg(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Cc(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Lg(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===El?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===su?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===dn&&(e="SHADOWMAP_TYPE_VSM"),e}function Ig(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Pi:case Li:e="ENVMAP_TYPE_CUBE";break;case gr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Dg(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Li:e="ENVMAP_MODE_REFRACTION";break}return e}function Ng(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case yl:e="ENVMAP_BLENDING_MULTIPLY";break;case Cu:e="ENVMAP_BLENDING_MIX";break;case Ru:e="ENVMAP_BLENDING_ADD";break}return e}function Ug(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Og(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Lg(t),l=Ig(t),h=Dg(t),u=Ng(t),d=Ug(t),f=t.isWebGL2?"":Eg(t),g=yg(t),_=bg(r),p=s.createProgram();let m,x,v=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+x);const S=v+m+a,C=v+x+o,A=yc(s,s.VERTEX_SHADER,S),w=yc(s,s.FRAGMENT_SHADER,C);s.attachShader(p,A),s.attachShader(p,w),t.index0AttributeName!==void 0?s.bindAttribLocation(p,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(p,0,"position"),s.linkProgram(p);function N($){if(i.debug.checkShaderErrors){const ee=s.getProgramInfoLog(p).trim(),P=s.getShaderInfoLog(A).trim(),U=s.getShaderInfoLog(w).trim();let O=!0,X=!0;if(s.getProgramParameter(p,s.LINK_STATUS)===!1)if(O=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,p,A,w);else{const q=bc(s,A,"vertex"),K=bc(s,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(p,s.VALIDATE_STATUS)+`

Program Info Log: `+ee+`
`+q+`
`+K)}else ee!==""?console.warn("THREE.WebGLProgram: Program Info Log:",ee):(P===""||U==="")&&(X=!1);X&&($.diagnostics={runnable:O,programLog:ee,vertexShader:{log:P,prefix:m},fragmentShader:{log:U,prefix:x}})}s.deleteShader(A),s.deleteShader(w),E=new Qs(s,p),b=Tg(s,p)}let E;this.getUniforms=function(){return E===void 0&&N(this),E};let b;this.getAttributes=function(){return b===void 0&&N(this),b};let F=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return F===!1&&(F=s.getProgramParameter(p,gg)),F},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(p),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=_g++,this.cacheKey=e,this.usedTimes=1,this.program=p,this.vertexShader=A,this.fragmentShader=w,this}let Fg=0;class zg{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Bg(e),t.set(e,n)),n}}class Bg{constructor(e){this.id=Fg++,this.code=e,this.usedTimes=0}}function kg(i,e,t,n,s,r,a){const o=new Ho,c=new zg,l=[],h=s.isWebGL2,u=s.logarithmicDepthBuffer,d=s.vertexTextures;let f=s.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(E){return E===0?"uv":`uv${E}`}function p(E,b,F,$,ee){const P=$.fog,U=ee.geometry,O=E.isMeshStandardMaterial?$.environment:null,X=(E.isMeshStandardMaterial?t:e).get(E.envMap||O),q=X&&X.mapping===gr?X.image.height:null,K=g[E.type];E.precision!==null&&(f=s.getMaxPrecision(E.precision),f!==E.precision&&console.warn("THREE.WebGLProgram.getParameters:",E.precision,"not supported, using",f,"instead."));const j=U.morphAttributes.position||U.morphAttributes.normal||U.morphAttributes.color,te=j!==void 0?j.length:0;let ae=0;U.morphAttributes.position!==void 0&&(ae=1),U.morphAttributes.normal!==void 0&&(ae=2),U.morphAttributes.color!==void 0&&(ae=3);let V,ne,_e,Te;if(K){const ft=tn[K];V=ft.vertexShader,ne=ft.fragmentShader}else V=E.vertexShader,ne=E.fragmentShader,c.update(E),_e=c.getVertexShaderID(E),Te=c.getFragmentShaderID(E);const Se=i.getRenderTarget(),Ne=ee.isInstancedMesh===!0,ze=ee.isBatchedMesh===!0,Ae=!!E.map,Fe=!!E.matcap,I=!!X,fe=!!E.aoMap,Q=!!E.lightMap,he=!!E.bumpMap,J=!!E.normalMap,Ce=!!E.displacementMap,xe=!!E.emissiveMap,y=!!E.metalnessMap,M=!!E.roughnessMap,z=E.anisotropy>0,oe=E.clearcoat>0,se=E.iridescence>0,ie=E.sheen>0,we=E.transmission>0,ge=z&&!!E.anisotropyMap,Ee=oe&&!!E.clearcoatMap,Ie=oe&&!!E.clearcoatNormalMap,Ge=oe&&!!E.clearcoatRoughnessMap,re=se&&!!E.iridescenceMap,Je=se&&!!E.iridescenceThicknessMap,$e=ie&&!!E.sheenColorMap,Be=ie&&!!E.sheenRoughnessMap,Le=!!E.specularMap,Me=!!E.specularColorMap,R=!!E.specularIntensityMap,ue=we&&!!E.transmissionMap,Re=we&&!!E.thicknessMap,be=!!E.gradientMap,ce=!!E.alphaMap,D=E.alphaTest>0,de=!!E.alphaHash,ve=!!E.extensions,Ue=!!U.attributes.uv1,De=!!U.attributes.uv2,Ze=!!U.attributes.uv3;let je=Pn;return E.toneMapped&&(Se===null||Se.isXRRenderTarget===!0)&&(je=i.toneMapping),{isWebGL2:h,shaderID:K,shaderType:E.type,shaderName:E.name,vertexShader:V,fragmentShader:ne,defines:E.defines,customVertexShaderID:_e,customFragmentShaderID:Te,isRawShaderMaterial:E.isRawShaderMaterial===!0,glslVersion:E.glslVersion,precision:f,batching:ze,instancing:Ne,instancingColor:Ne&&ee.instanceColor!==null,supportsVertexTextures:d,outputColorSpace:Se===null?i.outputColorSpace:Se.isXRRenderTarget===!0?Se.texture.colorSpace:_n,map:Ae,matcap:Fe,envMap:I,envMapMode:I&&X.mapping,envMapCubeUVHeight:q,aoMap:fe,lightMap:Q,bumpMap:he,normalMap:J,displacementMap:d&&Ce,emissiveMap:xe,normalMapObjectSpace:J&&E.normalMapType===qu,normalMapTangentSpace:J&&E.normalMapType===Dl,metalnessMap:y,roughnessMap:M,anisotropy:z,anisotropyMap:ge,clearcoat:oe,clearcoatMap:Ee,clearcoatNormalMap:Ie,clearcoatRoughnessMap:Ge,iridescence:se,iridescenceMap:re,iridescenceThicknessMap:Je,sheen:ie,sheenColorMap:$e,sheenRoughnessMap:Be,specularMap:Le,specularColorMap:Me,specularIntensityMap:R,transmission:we,transmissionMap:ue,thicknessMap:Re,gradientMap:be,opaque:E.transparent===!1&&E.blending===Ai,alphaMap:ce,alphaTest:D,alphaHash:de,combine:E.combine,mapUv:Ae&&_(E.map.channel),aoMapUv:fe&&_(E.aoMap.channel),lightMapUv:Q&&_(E.lightMap.channel),bumpMapUv:he&&_(E.bumpMap.channel),normalMapUv:J&&_(E.normalMap.channel),displacementMapUv:Ce&&_(E.displacementMap.channel),emissiveMapUv:xe&&_(E.emissiveMap.channel),metalnessMapUv:y&&_(E.metalnessMap.channel),roughnessMapUv:M&&_(E.roughnessMap.channel),anisotropyMapUv:ge&&_(E.anisotropyMap.channel),clearcoatMapUv:Ee&&_(E.clearcoatMap.channel),clearcoatNormalMapUv:Ie&&_(E.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ge&&_(E.clearcoatRoughnessMap.channel),iridescenceMapUv:re&&_(E.iridescenceMap.channel),iridescenceThicknessMapUv:Je&&_(E.iridescenceThicknessMap.channel),sheenColorMapUv:$e&&_(E.sheenColorMap.channel),sheenRoughnessMapUv:Be&&_(E.sheenRoughnessMap.channel),specularMapUv:Le&&_(E.specularMap.channel),specularColorMapUv:Me&&_(E.specularColorMap.channel),specularIntensityMapUv:R&&_(E.specularIntensityMap.channel),transmissionMapUv:ue&&_(E.transmissionMap.channel),thicknessMapUv:Re&&_(E.thicknessMap.channel),alphaMapUv:ce&&_(E.alphaMap.channel),vertexTangents:!!U.attributes.tangent&&(J||z),vertexColors:E.vertexColors,vertexAlphas:E.vertexColors===!0&&!!U.attributes.color&&U.attributes.color.itemSize===4,vertexUv1s:Ue,vertexUv2s:De,vertexUv3s:Ze,pointsUvs:ee.isPoints===!0&&!!U.attributes.uv&&(Ae||ce),fog:!!P,useFog:E.fog===!0,fogExp2:P&&P.isFogExp2,flatShading:E.flatShading===!0,sizeAttenuation:E.sizeAttenuation===!0,logarithmicDepthBuffer:u,skinning:ee.isSkinnedMesh===!0,morphTargets:U.morphAttributes.position!==void 0,morphNormals:U.morphAttributes.normal!==void 0,morphColors:U.morphAttributes.color!==void 0,morphTargetsCount:te,morphTextureStride:ae,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:E.dithering,shadowMapEnabled:i.shadowMap.enabled&&F.length>0,shadowMapType:i.shadowMap.type,toneMapping:je,useLegacyLights:i._useLegacyLights,decodeVideoTexture:Ae&&E.map.isVideoTexture===!0&&it.getTransfer(E.map.colorSpace)===at,premultipliedAlpha:E.premultipliedAlpha,doubleSided:E.side===Pt,flipSided:E.side===Ot,useDepthPacking:E.depthPacking>=0,depthPacking:E.depthPacking||0,index0AttributeName:E.index0AttributeName,extensionDerivatives:ve&&E.extensions.derivatives===!0,extensionFragDepth:ve&&E.extensions.fragDepth===!0,extensionDrawBuffers:ve&&E.extensions.drawBuffers===!0,extensionShaderTextureLOD:ve&&E.extensions.shaderTextureLOD===!0,extensionClipCullDistance:ve&&E.extensions.clipCullDistance&&n.has("WEBGL_clip_cull_distance"),rendererExtensionFragDepth:h||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:h||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:h||n.has("EXT_shader_texture_lod"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:E.customProgramCacheKey()}}function m(E){const b=[];if(E.shaderID?b.push(E.shaderID):(b.push(E.customVertexShaderID),b.push(E.customFragmentShaderID)),E.defines!==void 0)for(const F in E.defines)b.push(F),b.push(E.defines[F]);return E.isRawShaderMaterial===!1&&(x(b,E),v(b,E),b.push(i.outputColorSpace)),b.push(E.customProgramCacheKey),b.join()}function x(E,b){E.push(b.precision),E.push(b.outputColorSpace),E.push(b.envMapMode),E.push(b.envMapCubeUVHeight),E.push(b.mapUv),E.push(b.alphaMapUv),E.push(b.lightMapUv),E.push(b.aoMapUv),E.push(b.bumpMapUv),E.push(b.normalMapUv),E.push(b.displacementMapUv),E.push(b.emissiveMapUv),E.push(b.metalnessMapUv),E.push(b.roughnessMapUv),E.push(b.anisotropyMapUv),E.push(b.clearcoatMapUv),E.push(b.clearcoatNormalMapUv),E.push(b.clearcoatRoughnessMapUv),E.push(b.iridescenceMapUv),E.push(b.iridescenceThicknessMapUv),E.push(b.sheenColorMapUv),E.push(b.sheenRoughnessMapUv),E.push(b.specularMapUv),E.push(b.specularColorMapUv),E.push(b.specularIntensityMapUv),E.push(b.transmissionMapUv),E.push(b.thicknessMapUv),E.push(b.combine),E.push(b.fogExp2),E.push(b.sizeAttenuation),E.push(b.morphTargetsCount),E.push(b.morphAttributeCount),E.push(b.numDirLights),E.push(b.numPointLights),E.push(b.numSpotLights),E.push(b.numSpotLightMaps),E.push(b.numHemiLights),E.push(b.numRectAreaLights),E.push(b.numDirLightShadows),E.push(b.numPointLightShadows),E.push(b.numSpotLightShadows),E.push(b.numSpotLightShadowsWithMaps),E.push(b.numLightProbes),E.push(b.shadowMapType),E.push(b.toneMapping),E.push(b.numClippingPlanes),E.push(b.numClipIntersection),E.push(b.depthPacking)}function v(E,b){o.disableAll(),b.isWebGL2&&o.enable(0),b.supportsVertexTextures&&o.enable(1),b.instancing&&o.enable(2),b.instancingColor&&o.enable(3),b.matcap&&o.enable(4),b.envMap&&o.enable(5),b.normalMapObjectSpace&&o.enable(6),b.normalMapTangentSpace&&o.enable(7),b.clearcoat&&o.enable(8),b.iridescence&&o.enable(9),b.alphaTest&&o.enable(10),b.vertexColors&&o.enable(11),b.vertexAlphas&&o.enable(12),b.vertexUv1s&&o.enable(13),b.vertexUv2s&&o.enable(14),b.vertexUv3s&&o.enable(15),b.vertexTangents&&o.enable(16),b.anisotropy&&o.enable(17),b.alphaHash&&o.enable(18),b.batching&&o.enable(19),E.push(o.mask),o.disableAll(),b.fog&&o.enable(0),b.useFog&&o.enable(1),b.flatShading&&o.enable(2),b.logarithmicDepthBuffer&&o.enable(3),b.skinning&&o.enable(4),b.morphTargets&&o.enable(5),b.morphNormals&&o.enable(6),b.morphColors&&o.enable(7),b.premultipliedAlpha&&o.enable(8),b.shadowMapEnabled&&o.enable(9),b.useLegacyLights&&o.enable(10),b.doubleSided&&o.enable(11),b.flipSided&&o.enable(12),b.useDepthPacking&&o.enable(13),b.dithering&&o.enable(14),b.transmission&&o.enable(15),b.sheen&&o.enable(16),b.opaque&&o.enable(17),b.pointsUvs&&o.enable(18),b.decodeVideoTexture&&o.enable(19),E.push(o.mask)}function S(E){const b=g[E.type];let F;if(b){const $=tn[b];F=Md.clone($.uniforms)}else F=E.uniforms;return F}function C(E,b){let F;for(let $=0,ee=l.length;$<ee;$++){const P=l[$];if(P.cacheKey===b){F=P,++F.usedTimes;break}}return F===void 0&&(F=new Og(i,b,E,r),l.push(F)),F}function A(E){if(--E.usedTimes===0){const b=l.indexOf(E);l[b]=l[l.length-1],l.pop(),E.destroy()}}function w(E){c.remove(E)}function N(){c.dispose()}return{getParameters:p,getProgramCacheKey:m,getUniforms:S,acquireProgram:C,releaseProgram:A,releaseShaderCache:w,programs:l,dispose:N}}function Gg(){let i=new WeakMap;function e(r){let a=i.get(r);return a===void 0&&(a={},i.set(r,a)),a}function t(r){i.delete(r)}function n(r,a,o){i.get(r)[a]=o}function s(){i=new WeakMap}return{get:e,remove:t,update:n,dispose:s}}function Hg(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Rc(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Pc(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(u,d,f,g,_,p){let m=i[e];return m===void 0?(m={id:u.id,object:u,geometry:d,material:f,groupOrder:g,renderOrder:u.renderOrder,z:_,group:p},i[e]=m):(m.id=u.id,m.object=u,m.geometry=d,m.material=f,m.groupOrder=g,m.renderOrder=u.renderOrder,m.z=_,m.group=p),e++,m}function o(u,d,f,g,_,p){const m=a(u,d,f,g,_,p);f.transmission>0?n.push(m):f.transparent===!0?s.push(m):t.push(m)}function c(u,d,f,g,_,p){const m=a(u,d,f,g,_,p);f.transmission>0?n.unshift(m):f.transparent===!0?s.unshift(m):t.unshift(m)}function l(u,d){t.length>1&&t.sort(u||Hg),n.length>1&&n.sort(d||Rc),s.length>1&&s.sort(d||Rc)}function h(){for(let u=e,d=i.length;u<d;u++){const f=i[u];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:o,unshift:c,finish:h,sort:l}}function Vg(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new Pc,i.set(n,[a])):s>=r.length?(a=new Pc,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function Wg(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new L,color:new Ke};break;case"SpotLight":t={position:new L,direction:new L,color:new Ke,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new L,color:new Ke,distance:0,decay:0};break;case"HemisphereLight":t={direction:new L,skyColor:new Ke,groundColor:new Ke};break;case"RectAreaLight":t={color:new Ke,position:new L,halfWidth:new L,halfHeight:new L};break}return i[e.id]=t,t}}}function $g(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new le};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new le};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new le,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Xg=0;function qg(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Yg(i,e){const t=new Wg,n=$g(),s={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let h=0;h<9;h++)s.probe.push(new L);const r=new L,a=new st,o=new st;function c(h,u){let d=0,f=0,g=0;for(let $=0;$<9;$++)s.probe[$].set(0,0,0);let _=0,p=0,m=0,x=0,v=0,S=0,C=0,A=0,w=0,N=0,E=0;h.sort(qg);const b=u===!0?Math.PI:1;for(let $=0,ee=h.length;$<ee;$++){const P=h[$],U=P.color,O=P.intensity,X=P.distance,q=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)d+=U.r*O*b,f+=U.g*O*b,g+=U.b*O*b;else if(P.isLightProbe){for(let K=0;K<9;K++)s.probe[K].addScaledVector(P.sh.coefficients[K],O);E++}else if(P.isDirectionalLight){const K=t.get(P);if(K.color.copy(P.color).multiplyScalar(P.intensity*b),P.castShadow){const j=P.shadow,te=n.get(P);te.shadowBias=j.bias,te.shadowNormalBias=j.normalBias,te.shadowRadius=j.radius,te.shadowMapSize=j.mapSize,s.directionalShadow[_]=te,s.directionalShadowMap[_]=q,s.directionalShadowMatrix[_]=P.shadow.matrix,S++}s.directional[_]=K,_++}else if(P.isSpotLight){const K=t.get(P);K.position.setFromMatrixPosition(P.matrixWorld),K.color.copy(U).multiplyScalar(O*b),K.distance=X,K.coneCos=Math.cos(P.angle),K.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),K.decay=P.decay,s.spot[m]=K;const j=P.shadow;if(P.map&&(s.spotLightMap[w]=P.map,w++,j.updateMatrices(P),P.castShadow&&N++),s.spotLightMatrix[m]=j.matrix,P.castShadow){const te=n.get(P);te.shadowBias=j.bias,te.shadowNormalBias=j.normalBias,te.shadowRadius=j.radius,te.shadowMapSize=j.mapSize,s.spotShadow[m]=te,s.spotShadowMap[m]=q,A++}m++}else if(P.isRectAreaLight){const K=t.get(P);K.color.copy(U).multiplyScalar(O),K.halfWidth.set(P.width*.5,0,0),K.halfHeight.set(0,P.height*.5,0),s.rectArea[x]=K,x++}else if(P.isPointLight){const K=t.get(P);if(K.color.copy(P.color).multiplyScalar(P.intensity*b),K.distance=P.distance,K.decay=P.decay,P.castShadow){const j=P.shadow,te=n.get(P);te.shadowBias=j.bias,te.shadowNormalBias=j.normalBias,te.shadowRadius=j.radius,te.shadowMapSize=j.mapSize,te.shadowCameraNear=j.camera.near,te.shadowCameraFar=j.camera.far,s.pointShadow[p]=te,s.pointShadowMap[p]=q,s.pointShadowMatrix[p]=P.shadow.matrix,C++}s.point[p]=K,p++}else if(P.isHemisphereLight){const K=t.get(P);K.skyColor.copy(P.color).multiplyScalar(O*b),K.groundColor.copy(P.groundColor).multiplyScalar(O*b),s.hemi[v]=K,v++}}x>0&&(e.isWebGL2?i.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=me.LTC_FLOAT_1,s.rectAreaLTC2=me.LTC_FLOAT_2):(s.rectAreaLTC1=me.LTC_HALF_1,s.rectAreaLTC2=me.LTC_HALF_2):i.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=me.LTC_FLOAT_1,s.rectAreaLTC2=me.LTC_FLOAT_2):i.has("OES_texture_half_float_linear")===!0?(s.rectAreaLTC1=me.LTC_HALF_1,s.rectAreaLTC2=me.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),s.ambient[0]=d,s.ambient[1]=f,s.ambient[2]=g;const F=s.hash;(F.directionalLength!==_||F.pointLength!==p||F.spotLength!==m||F.rectAreaLength!==x||F.hemiLength!==v||F.numDirectionalShadows!==S||F.numPointShadows!==C||F.numSpotShadows!==A||F.numSpotMaps!==w||F.numLightProbes!==E)&&(s.directional.length=_,s.spot.length=m,s.rectArea.length=x,s.point.length=p,s.hemi.length=v,s.directionalShadow.length=S,s.directionalShadowMap.length=S,s.pointShadow.length=C,s.pointShadowMap.length=C,s.spotShadow.length=A,s.spotShadowMap.length=A,s.directionalShadowMatrix.length=S,s.pointShadowMatrix.length=C,s.spotLightMatrix.length=A+w-N,s.spotLightMap.length=w,s.numSpotLightShadowsWithMaps=N,s.numLightProbes=E,F.directionalLength=_,F.pointLength=p,F.spotLength=m,F.rectAreaLength=x,F.hemiLength=v,F.numDirectionalShadows=S,F.numPointShadows=C,F.numSpotShadows=A,F.numSpotMaps=w,F.numLightProbes=E,s.version=Xg++)}function l(h,u){let d=0,f=0,g=0,_=0,p=0;const m=u.matrixWorldInverse;for(let x=0,v=h.length;x<v;x++){const S=h[x];if(S.isDirectionalLight){const C=s.directional[d];C.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),C.direction.sub(r),C.direction.transformDirection(m),d++}else if(S.isSpotLight){const C=s.spot[g];C.position.setFromMatrixPosition(S.matrixWorld),C.position.applyMatrix4(m),C.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),C.direction.sub(r),C.direction.transformDirection(m),g++}else if(S.isRectAreaLight){const C=s.rectArea[_];C.position.setFromMatrixPosition(S.matrixWorld),C.position.applyMatrix4(m),o.identity(),a.copy(S.matrixWorld),a.premultiply(m),o.extractRotation(a),C.halfWidth.set(S.width*.5,0,0),C.halfHeight.set(0,S.height*.5,0),C.halfWidth.applyMatrix4(o),C.halfHeight.applyMatrix4(o),_++}else if(S.isPointLight){const C=s.point[f];C.position.setFromMatrixPosition(S.matrixWorld),C.position.applyMatrix4(m),f++}else if(S.isHemisphereLight){const C=s.hemi[p];C.direction.setFromMatrixPosition(S.matrixWorld),C.direction.transformDirection(m),p++}}}return{setup:c,setupView:l,state:s}}function Lc(i,e){const t=new Yg(i,e),n=[],s=[];function r(){n.length=0,s.length=0}function a(u){n.push(u)}function o(u){s.push(u)}function c(u){t.setup(n,u)}function l(u){t.setupView(n,u)}return{init:r,state:{lightsArray:n,shadowsArray:s,lights:t},setupLights:c,setupLightsView:l,pushLight:a,pushShadow:o}}function Zg(i,e){let t=new WeakMap;function n(r,a=0){const o=t.get(r);let c;return o===void 0?(c=new Lc(i,e),t.set(r,[c])):a>=o.length?(c=new Lc(i,e),o.push(c)):c=o[a],c}function s(){t=new WeakMap}return{get:n,dispose:s}}class jg extends Un{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=$u,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Kg extends Un{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Jg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      white-space: nowrap;
    `;const r=new K_(s);r.position.set(t,1,n),this.labelGroup.add(r)}setLabelsVisible(e){this.labelGroup.visible=e,this.gridOverlayGroup.visible=e,this.labelRenderer.domElement.style.display=e?"block":"none"}getLabelsVisible(){return this.labelGroup.visible}fitToLayout(){if(this.trackGroup.children.length===0)return;const e=new Fn().setFromObject(this.trackGroup);this.layoutBounds=e;const t=e.getCenter(new L),n=e.getSize(new L),s=this.container.clientWidth/this.container.clientHeight,r=n.x/n.z;let a,o;r>s?(a=n.x/.9,o=a/s):(o=n.z/.9,a=o*s),this.camera.left=-a/2,this.camera.right=a/2,this.camera.top=o/2,this.camera.bottom=-o/2,this.camera.zoom=1,this.camera.position.set(t.x,100,t.z),this.camera.lookAt(t.x,0,t.z),this.camera.updateProjectionMatrix(),this.controls.target.set(t.x,0,t.z),this.controls.update()}}function lo(i,e,t){return{x:i,y:e,z:t}}function Z(i,e){return{x:i,y:0,z:e}}function $n(i,e,t){const n=[],s=e*Math.PI/180;for(let r=0;r<t;r++){const o=r/(t-1)*s;n.push(Z(i*Math.sin(o),i*(1-Math.cos(o))))}return n}function Ei(i,e,t){return $n(i,e,t).map(s=>Z(s.x,-s.z))}function ho(i){const e=i*Math.PI/180;return Z(Math.cos(e),Math.sin(e))}function uo(i){const e=i*Math.PI/180;return Z(Math.cos(e),-Math.sin(e))}const iv=[{code:"ph",aliases:["placeholder"],sections:[],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[]},{name:"out",position:Z(0,0),direction:Z(1,0),sectionIndices:[]}]},{code:"str9",aliases:["str"],sections:[{splinePoints:[Z(0,0),Z(9,0)]}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Z(9,0),direction:Z(1,0),sectionIndices:[0]}]},{code:"str6",aliases:[],sections:[{splinePoints:[Z(0,0),Z(6,0)]}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Z(6,0),direction:Z(1,0),sectionIndices:[0]}]},{code:"str3",aliases:[],sections:[{splinePoints:[Z(0,0),Z(3,0)]}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Z(3,0),direction:Z(1,0),sectionIndices:[0]}]},{code:"str15",aliases:[],sections:[{splinePoints:[Z(0,0),Z(1.5,0)]}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Z(1.5,0),direction:Z(1,0),sectionIndices:[0]}]},{code:"crvl18",aliases:[],sections:[{splinePoints:$n(18,22.5,7)}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:$n(18,22.5,7)[6],direction:ho(22.5),sectionIndices:[0]}]},{code:"crvl22",aliases:["crvl","crv"],sections:[{splinePoints:$n(22,22.5,7)}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:$n(22,22.5,7)[6],direction:ho(22.5),sectionIndices:[0]}]},{code:"crvl24",aliases:[],sections:[{splinePoints:$n(24,22.5,7)}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:$n(24,22.5,7)[6],direction:ho(22.5),sectionIndices:[0]}]},{code:"crvr18",aliases:[],sections:[{splinePoints:Ei(18,22.5,7)}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Ei(18,22.5,7)[6],direction:uo(22.5),sectionIndices:[0]}]},{code:"crvr22",aliases:["crvr"],sections:[{splinePoints:Ei(22,22.5,7)}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Ei(22,22.5,7)[6],direction:uo(22.5),sectionIndices:[0]}]},{code:"crvr24",aliases:[],sections:[{splinePoints:Ei(24,22.5,7)}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Ei(24,22.5,7)[6],direction:uo(22.5),sectionIndices:[0]}]},{code:"bump",aliases:["bumper"],sections:[{splinePoints:[Z(0,0),Z(3,0)]}],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Z(3,0),direction:Z(1,0),sectionIndices:[0]}]},{code:"gen",aliases:["generator"],sections:[{splinePoints:[Z(-50,0),Z(0,0)]}],connectionPoints:[{name:"in",position:Z(-50,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out",position:Z(0,0),direction:Z(1,0),sectionIndices:[0]}]},{code:"bin",aliases:[],sections:[],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[]},{name:"out",position:Z(0,0),direction:Z(1,0),sectionIndices:[]}]},{code:"tun",aliases:["tunnel"],sections:[],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[]},{name:"out",position:Z(0,0),direction:Z(1,0),sectionIndices:[]}]},{code:"sem",aliases:["semaphore"],sections:[],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[]},{name:"out",position:Z(0,0),direction:Z(1,0),sectionIndices:[]}]},{code:"dec",aliases:["decoupler"],sections:[],connectionPoints:[{name:"in",position:Z(0,0),direction:Z(-1,0),sectionIndices:[]},{name:"out",position:Z(0,0),direction:Z(1,0),sectionIndices:[]}]},{code:"x90",aliases:[],sections:[{splinePoints:[Z(-3,0),Z(3,0)]},{splinePoints:[Z(0,-3),Z(0,3)]}],connectionPoints:[{name:"in1",position:Z(-3,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out1",position:Z(3,0),direction:Z(1,0),sectionIndices:[0]},{name:"in2",position:Z(0,-3),direction:Z(0,-1),sectionIndices:[1]},{name:"out2",position:Z(0,3),direction:Z(0,1),sectionIndices:[1]}]},{code:"x45",aliases:[],sections:[{splinePoints:[Z(-3,0),Z(3,0)]},{splinePoints:[Z(-2.12,-2.12),Z(2.12,2.12)]}],connectionPoints:[{name:"in1",position:Z(-3,0),direction:Z(-1,0),sectionIndices:[0]},{name:"out1",position:Z(3,0),direction:Z(1,0),sectionIndices:[0]},{name:"in2",position:Z(-2.12,-2.12),direction:Z(-.707,-.707),sectionIndices:[1]},{name:"out2",position:Z(2.12,2.12),direction:Z(.707,.707),sectionIndices:[1]}]}],hh=new Map,uh=new Map;for(const i of iv){hh.set(i.code,i);for(const e of i.aliases)uh.set(e,i)}const dh=new Map;function Zt(i){dh.set(i.code.toLowerCase(),i)}function nt(i){const e=i.toLowerCase(),t=dh.get(e);if(t)return t;const n=hh.get(e)||uh.get(e);if(!n)throw new Error(`Unknown track archetype: ${i}`);return n}const sv=[2972190,3368482,3828522],rv=3832767;let fo=null,po=null;function ov(){return fo||(fo=sv.map(i=>new $t({color:i,side:Pt}))),fo}function av(){return po||(po=new $t({color:rv,side:Pt})),po}let mo=null;function fh(){return mo||(mo=new us(1,12)),mo}const cv=8,il=.3,Ys=.1,sl=2,lv=3,hv=20,uv=3;function dv(i,e){var _,p,m,x,v,S,C;const t=!!e.treesEnabled,n=!!e.pondEnabled;if(!t&&!n)return;const s=(_=e.gridSize)!=null?_:cv,r=rl(e.pieces);if(!r)return;const a=r.maxX-r.minX,o=r.maxZ-r.minZ,c=a*il,l=o*il;r.minX-=c,r.maxX+=c,r.minZ-=l,r.maxZ+=l;const h=Math.max(1,Math.ceil((r.maxX-r.minX)/s)),u=Math.max(1,Math.ceil((r.maxZ-r.minZ)/s)),d=[];for(let A=0;A<u;A++)d[A]=new Array(h).fill(-1);if(fv(d,r,e.pieces,h,u,s),ph(d,h,u),n){const A=(p=e.pondSize)!=null?p:hv,w=(m=e.pondClearance)!=null?m:uv,N=rl(e.pieces),E=N.maxX-N.minX,b=N.maxZ-N.minZ,F={minX:N.minX-E*Ys,maxX:N.maxX+E*Ys,minZ:N.minZ-b*Ys,maxZ:N.maxZ+b*Ys},{group:$,pondCells:ee,minOriginalScore:P}=mv(d,r,F,h,u,A,w,s);i.addSceneryGroup($);const U=(x=e.pondScore)!=null?x:Math.max(0,P-1);_v(d,h,u,ee,U)}const f=(v=e.treesClearance)!=null?v:sl,g=gv(d,r,h,u,f,s);if(i.addGridOverlay(g),t){const A=(S=e.treesClearance)!=null?S:sl,w=(C=e.treesDensity)!=null?C:lv,N=e.treesFactor,E=pv(d,r,h,u,A,w,N,s);i.addSceneryGroup(E)}}function rl(i){if(i.length===0)return null;let e=1/0,t=-1/0,n=1/0,s=-1/0;for(const r of i){const a=nt(r.archetypeCode);if(!a)continue;const o=Math.cos(r.rotation),c=Math.sin(r.rotation),l=h=>({x:r.position.x+(h.x*o-h.z*c),z:-(r.position.z+(h.x*c+h.z*o))});for(const h of a.connectionPoints){const u=l(h.position);e=Math.min(e,u.x),t=Math.max(t,u.x),n=Math.min(n,u.z),s=Math.max(s,u.z)}for(const h of a.sections)for(const u of h.splinePoints){const d=l(u);e=Math.min(e,d.x),t=Math.max(t,d.x),n=Math.min(n,d.z),s=Math.max(s,d.z)}}return isFinite(e)?{minX:e,maxX:t,minZ:n,maxZ:s}:null}function ol(i,e,t,n,s,r){const a=Math.floor((i-t.minX)/r),o=Math.floor((e-t.minZ)/r);return a<0||a>=n||o<0||o>=s?null:{col:a,row:o}}function fv(i,e,t,n,s,r){for(const a of t){if(a.inTunnel)continue;const o=nt(a.archetypeCode);if(!o)continue;const c=o.code;if(c==="gen"||c==="bin")continue;const l=Math.cos(a.rotation),h=Math.sin(a.rotation),u=d=>new L(a.position.x+(d.x*l-d.z*h),d.y,-(a.position.z+(d.x*h+d.z*l)));for(const d of o.sections){if(d.splinePoints.length<2)continue;const f=d.splinePoints.map(m=>u(m)),g=new In(f),_=g.getLength(),p=Math.max(2,Math.ceil(_));for(let m=0;m<=p;m++){const x=m/p,v=g.getPointAt(x),S=ol(v.x,v.z,e,n,s,r);S&&(i[S.row][S.col]=0)}}for(const d of o.connectionPoints){const f=u(d.position),g=ol(f.x,f.z,e,n,s,r);g&&(i[g.row][g.col]=0)}}}function ph(i,e,t){const n=new Map;for(let c=0;c<t;c++)for(let l=0;l<e;l++){const h=i[c][l];h>=0&&(n.has(h)||n.set(h,[]),n.get(h).push([c,l]))}const s=[],r=[...n.keys()].sort((c,l)=>c-l);for(const c of r)s.push(...n.get(c));const a=[[-1,0],[1,0],[0,-1],[0,1]];let o=0;for(;o<s.length;){const[c,l]=s[o++],h=i[c][l];for(const[u,d]of a){const f=c+u,g=l+d;f>=0&&f<t&&g>=0&&g<e&&i[f][g]===-1&&(i[f][g]=h+1,s.push([f,g]))}}}function pv(i,e,t,n,s,r,a,o){const c=new _t,l=ov(),h=fh();let u=12345;const d=()=>(u=(u*16807+0)%2147483647,(u-1)/2147483646),f=[];for(let m=0;m<n;m++)for(let x=0;x<t;x++){const v=i[m][x];if(v<s)continue;let S;a!==void 0?S=Math.floor(a*v):S=Math.min(r,v-s+1);for(let C=0;C<S;C++){const A=e.minX+(x+d())*o,w=e.minZ+(m+d())*o,N=3+Math.floor(d()*3);for(let E=0;E<N;E++){const b=Math.floor(d()*l.length),F=1+d()*2,$=(d()-.5)*2,ee=(d()-.5)*2;f.push({x:A+$,z:w+ee,radius:F,materialIndex:b})}}}if(f.length===0)return c;const g=l.map(()=>[]);for(const m of f)g[m.materialIndex].push(m);const _=new vn().setFromEuler(new Fi(-Math.PI/2,0,0)),p=new st;for(let m=0;m<l.length;m++){const x=g[m];if(x.length===0)continue;const v=new Ql(h,l[m],x.length);v.frustumCulled=!1;for(let S=0;S<x.length;S++){const{x:C,z:A,radius:w}=x[S];p.compose(new L(C,.005,A),_,new L(w,w,w)),v.setMatrixAt(S,p)}v.instanceMatrix.needsUpdate=!0,c.add(v)}return c}function mv(i,e,t,n,s,r,a,o){const c=new _t,l=new Set,h=()=>Math.random(),u=[];for(let U=0;U<s;U++)for(let O=0;O<n;O++)if(i[U][O]>=a){const X=e.minX+(O+.5)*o,q=e.minZ+(U+.5)*o;X>=t.minX&&X<=t.maxX&&q>=t.minZ&&q<=t.maxZ&&u.push([U,O])}if(u.length===0)return{group:c,pondCells:l,minOriginalScore:0};const d=Math.floor(h()*u.length),[f,g]=u[d],_=new Set,p=[],m=new Set,x=[[-1,0],[1,0],[0,-1],[0,1]];let v=f,S=f,C=g,A=g,w=1/0;const N=(U,O)=>{const X=`${U},${O}`;_.add(X),l.add(X),w=Math.min(w,i[U][O]),v=Math.min(v,U),S=Math.max(S,U),C=Math.min(C,O),A=Math.max(A,O);for(const[q,K]of x){const j=U+q,te=O+K,ae=`${j},${te}`;j>=0&&j<s&&te>=0&&te<n&&i[j][te]>=a&&!_.has(ae)&&!m.has(ae)&&(p.push([j,te]),m.add(ae))}};for(N(f,g);_.size<r&&p.length>0;){const U=Math.floor(h()*p.length),[O,X]=p[U];if(p[U]=p[p.length-1],p.pop(),m.delete(`${O},${X}`),_.has(`${O},${X}`))continue;const q=Math.min(v,O),K=Math.max(S,O),j=Math.min(C,X),te=Math.max(A,X),ae=K-q+1,ne=(te-j+1)/ae;ne<.5||ne>2||N(O,X)}if(_.size===0)return{group:c,pondCells:l,minOriginalScore:0};const E=av(),b=fh(),F=[];for(const U of _){const[O,X]=U.split(",").map(Number),q=e.minX+(X+.5)*o,K=e.minZ+(O+.5)*o;F.push({x:q,z:K,radius:o*1.1});for(const[j,te]of[[0,1],[1,0]]){const ae=`${O+j},${X+te}`;_.has(ae)&&F.push({x:q+te*o*.5,z:K+j*o*.5,radius:o*.9})}for(const[j,te]of x){const ae=`${O+j},${X+te}`;if(!_.has(ae))for(let V=0;V<3;V++){const ne=(V-1)*o*.3,_e=(h()-.5)*o*.15,Te=te===0?ne+_e:0,Se=j===0?ne+_e:0;F.push({x:q+te*o*.3+Te,z:K+j*o*.3+Se,radius:o*(.5+h()*.25)})}}}if(F.length===0)return{group:c,pondCells:l,minOriginalScore:w};const $=new vn().setFromEuler(new Fi(-Math.PI/2,0,0)),ee=new st,P=new Ql(b,E,F.length);P.frustumCulled=!1;for(let U=0;U<F.length;U++){const{x:O,z:X,radius:q}=F[U];ee.compose(new L(O,.003,X),$,new L(q,q,q)),P.setMatrixAt(U,ee)}return P.instanceMatrix.needsUpdate=!0,c.add(P),{group:c,pondCells:l,minOriginalScore:w}}function gv(i,e,t,n,s,r){const a=new _t,o=32,c=4096,l=t*o,h=n*o,u=Math.min(1,c/Math.max(l,h)),d=Math.ceil(l*u),f=Math.ceil(h*u),g=d/t,_=document.createElement("canvas");_.width=d,_.height=f;const p=_.getContext("2d");p.clearRect(0,0,d,f);let m=0;for(let N=0;N<n;N++)for(let E=0;E<t;E++)i[N][E]>m&&(m=i[N][E]);for(let N=0;N<n;N++)for(let E=0;E<t;E++){const b=i[N][E];if(b<0)continue;const F=E*g,$=N*g;if(b===0)p.fillStyle="rgba(120, 120, 120, 0.5)";else if(b<s)p.fillStyle="rgba(200, 180, 50, 0.4)";else{const ee=Math.min((b-s)/Math.max(m-s,1),1),P=Math.floor(60-ee*40),U=Math.floor(120+ee*100),O=Math.floor(60-ee*30);p.fillStyle=`rgba(${P}, ${U}, ${O}, 0.4)`}if(p.fillRect(F,$,g,g),p.strokeStyle="rgba(0, 0, 0, 0.3)",p.lineWidth=Math.max(.5,g*.03),p.strokeRect(F+.5,$+.5,g-1,g-1),g>=12){const ee=Math.max(8,Math.floor(g*.55));p.fillStyle="rgba(0, 0, 0, 0.7)",p.font=`bold ${ee}px monospace`,p.textAlign="center",p.textBaseline="middle",p.fillText(String(b),F+g/2,$+g/2)}}const x=new f_(_);x.generateMipmaps=!1,x.minFilter=Ut,x.magFilter=Ut;const v=t*r,S=n*r,C=new hs(v,S),A=new $t({map:x,transparent:!0,depthWrite:!1,side:Pt}),w=new tt(C,A);return w.rotation.x=-Math.PI/2,w.position.set(e.minX+v/2,.008,e.minZ+S/2),a.add(w),a}function _v(i,e,t,n,s){if(n.size!==0){for(const r of n){const[a,o]=r.split(",").map(Number);i[a][o]=s}for(let r=0;r<t;r++)for(let a=0;a<e;a++){const o=`${r},${a}`;i[r][a]===0||n.has(o)||(i[r][a]=-1)}ph(i,e,t)}}var nn=(i=>(i[i.DEBUG=0]="DEBUG",i[i.INFO=1]="INFO",i[i.WARNING=2]="WARNING",i[i.ERROR=3]="ERROR",i))(nn||{});let Ki=2;function mh(i){Ki=i}const Y={debug(i,...e){Ki<=0&&console.log(`[DEBUG] ${i}`,...e)},info(i,...e){Ki<=1&&console.log(`[INFO] ${i}`,...e)},warn(i,...e){Ki<=2&&console.warn(`[WARN] ${i}`,...e)},error(i,...e){Ki<=3&&console.error(`[ERROR] ${i}`,...e)}},vv=12632264,xv=3022872,Sv=5921362,Mv=5912624,gh=16777215,Ev=16711680,yv=2271778,bv=13378082,Tv=4868682,wv=65280,Av=16711680,_h=65280,vh=16711680,Cv=3355443,xh=16746496,Sh=16711680,Rv=1.045,go=.08,Pv=1.45,_o=.15,Lv=.25,Iv=1,Dv=2,Mh=2.64,Zs=.1,Ri=new Map,Ko=new Map,Jo=new Map,Qo=new Map;function Nv(i){Ri.has(i)||Ri.set(i,0);const e=Ri.get(i);return Y.debug(`getSelectedRouteByKey: key="${i}" → ${e}`),e}function Eh(i,e){const t=Ri.get(i);Y.debug(`setSelectedRouteByKey: key="${i}" ${t} → ${e}`),Ri.set(i,e)}function Uv(){return Ri}function Ov(i,e){for(const[t,n]of Ko)if(n.visible=e,e){const s=n.material,r=i.has(t);s.color.setHex(r?Ev:gh)}}function Fv(i,e){const t=Jo.get(i);t&&t.dot.material.color.setHex(e?vh:_h)}function al(i,e){const t=Qo.get(i);if(t)for(const n of t)n.material.color.setHex(e?Sh:xh)}function ki(i,e,t=!1){var r;t?i.clearTrack():i.clearLayout(),Ko.clear(),Jo.clear(),Qo.clear();const n=new Map;for(const a of e.pieces)n.set(a.id,a);const s=(r=e.randomSwitches)!=null?r:!1;for(const a of e.pieces){const o=nt(a.archetypeCode),c=zv(a,o,n,s);if(i.addTrackGroup(c),a.label){const l=$v(a,o),h=2,u=Math.cos(a.rotation+Math.PI/2)*h,d=-Math.sin(a.rotation+Math.PI/2)*h;i.addLabel(a.label,l.x+u,l.z+d)}}t||dv(i,e),i.fitToLayout(),i.render()}function zv(i,e,t,n=!1){var h,u,d,f;const s=new _t,r=Math.cos(i.rotation),a=Math.sin(i.rotation),o=g=>new L(i.position.x+(g.x*r-g.z*a),g.y,-(i.position.z+(g.x*a+g.z*r))),l=e.code==="gen"||e.code==="bin"||i.inTunnel;if(!l){for(const g of e.sections)if(g.splinePoints.length>=2){const _=g.splinePoints.map(m=>o(m)),p=Bv(_);s.add(p)}}if(!l){for(const g of e.connectionPoints){const _=o({x:g.position.x,y:0,z:g.position.z}),p=`${i.id}.${g.name}`,m=i.connections.get(g.name)||[],x=ll(_,p);if(s.add(x),Y.debug(`  ${i.id}.${g.name}: ${m.length} connections`),m.length>1&&!n){const v=Jv(i,g.name,_,m,t);for(const S of v)s.add(S)}}if(i.internalConnectionPoints)for(const g of i.internalConnectionPoints){const _=new L(g.worldPosition.x,0,-g.worldPosition.z),p=ll(_,g.id);s.add(p),Y.debug(`  Internal connection point ${g.id} at (${g.worldPosition.x.toFixed(1)}, ${g.worldPosition.z.toFixed(1)})`)}}if(e.code==="gen"){const g=o({x:0,y:0,z:0}),_=kv(g);_.userData={isGenerator:!0,pieceId:i.id},s.add(_)}else if(e.code==="bin"){const g=o({x:0,y:0,z:0}),_=Gv(g);s.add(_)}else if(e.code==="bump"||e.code==="bumper"){const g=Xv(i,e,o);s.add(g)}else if(e.code==="tun"||e.code==="tunnel"){const g=Wv(i);for(const _ of g)s.add(_)}else if(e.code==="sem"||e.code==="semaphore"){const g=o({x:0,y:0,z:0}),_=(u=(h=i.semaphoreConfig)==null?void 0:h.locked)!=null?u:!1,p=Hv(g,i.id,_);s.add(p)}else if(e.code==="dec"||e.code==="decoupler"){const g=o({x:0,y:0,z:0}),_=(f=(d=i.decouplerConfig)==null?void 0:d.activated)!=null?f:!1,p=Vv(g,i.id,i.rotation,_);s.add(p)}return s}function Bv(i){const e=new _t,t=new In(i),n=t.getLength(),s=Math.max(16,i.length*8),r=new Cn({color:vv,roughness:.2,metalness:.85,envMapIntensity:1}),a=new Cn({color:xv,roughness:.9,metalness:0}),o=new Cn({color:Sv,roughness:1,metalness:0}),c=new Cn({color:Mv,roughness:.9,metalness:0}),l=cl(t,s,Mh,Zs),h=new tt(l,c);h.position.y=.01,e.add(h);const u=cl(t,s,Dv,.08),d=new tt(u,o);d.position.y=Zs+.02,e.add(d);const f=new On(Lv,_o,Pv),g=Math.floor(n/Iv);for(let b=0;b<=g;b++){const F=b/Math.max(g,1),$=t.getPointAt(F),ee=t.getTangentAt(F),P=new tt(f,a);P.position.set($.x,Zs+.08+_o/2,$.z);const U=Math.atan2(-ee.z,ee.x);P.rotation.y=U,e.add(P)}const _=Rv/2,p=[],m=[],x=s;for(let b=0;b<=x;b++){const F=b/x,$=t.getPointAt(F),ee=t.getTangentAt(F),P=-ee.z,U=ee.x;p.push(new L($.x+P*_,$.y,$.z+U*_)),m.push(new L($.x-P*_,$.y,$.z-U*_))}const v=new In(p),S=new In(m),C=new ur(v,s,go,6,!1),A=new ur(S,s,go,6,!1),w=new tt(C,r),N=new tt(A,r),E=Zs+.08+_o+go;return w.position.y=E,N.position.y=E,e.add(w),e.add(N),e}function cl(i,e,t,n){const s=t/2,r=[],a=[];for(let c=0;c<=e;c++){const l=c/e,h=i.getPointAt(l),u=i.getTangentAt(l),d=-u.z,f=u.x;r.push(h.x+d*s,0,h.z+f*s),r.push(h.x-d*s,0,h.z-f*s),r.push(h.x-d*s,n,h.z-f*s),r.push(h.x+d*s,n,h.z+f*s)}for(let c=0;c<e;c++){const l=c*4;a.push(l+3,l+2,l+6),a.push(l+3,l+6,l+7),a.push(l+0,l+3,l+7),a.push(l+0,l+7,l+4),a.push(l+2,l+1,l+5),a.push(l+2,l+5,l+6),a.push(l+0,l+4,l+5),a.push(l+0,l+5,l+1)}const o=new Lt;return o.setAttribute("position",new rt(r,3)),o.setIndex(a),o.computeVertexNormals(),o}function ll(i,e){const t=new fs(.25,16,16),n=new $t({color:gh}),s=new tt(t,n);return s.position.set(i.x,.5,i.z),s.visible=!1,Ko.set(e,s),s}function kv(i){const e=new us(1.5,32),t=new $t({color:yv,side:Pt}),n=new tt(e,t);return n.rotation.x=-Math.PI/2,n.position.set(i.x,.6,i.z),n}function Gv(i){const e=new us(1.5,32),t=new $t({color:bv,side:Pt}),n=new tt(e,t);return n.rotation.x=-Math.PI/2,n.position.set(i.x,.5,i.z),n}function Hv(i,e,t){const n=new _t,s=new Yo(1.3,1.5,32),r=new $t({color:Cv,side:Pt}),a=new tt(s,r);a.rotation.x=-Math.PI/2,a.position.set(i.x,.55,i.z),n.add(a);const o=new fs(.6,16,16),c=t?vh:_h,l=new $t({color:c}),h=new tt(o,l);return h.position.set(i.x,.7,i.z),h.userData={isSemaphore:!0,pieceId:e},n.add(h),Jo.set(e,{dot:h,ring:a}),n}function Vv(i,e,t,n){const s=new _t,r=n?Sh:xh,a=1.13,o=1.5,c=-Math.sin(-t),l=-Math.cos(-t),h=new Bi;h.moveTo(0,a),h.lineTo(-a*.7,-a*.5),h.lineTo(a*.7,-a*.5),h.lineTo(0,a);const u=new Zo(h),d=new $t({color:r,side:Pt}),f=new tt(u,d.clone());f.rotation.x=-Math.PI/2,f.rotation.z=-t,f.position.set(i.x+c*o,.6,i.z+l*o),f.userData={isDecoupler:!0,pieceId:e},s.add(f);const g=new tt(u,d.clone());return g.rotation.x=-Math.PI/2,g.rotation.z=Math.PI-t,g.position.set(i.x-c*o,.6,i.z-l*o),g.userData={isDecoupler:!0,pieceId:e},s.add(g),Qo.set(e,[f,g]),s}function Wv(i){const e=[],a=new Cn({color:Tv,roughness:.7,metalness:.2}),c=(()=>{const u=new Bi,d=4.2/2,f=.3;u.moveTo(-d,0),u.lineTo(-d,.8),u.lineTo(-d+f,.8),u.lineTo(-d+f,f),u.lineTo(d-f,f),u.lineTo(d-f,.8),u.lineTo(d,.8),u.lineTo(d,0),u.lineTo(-d,0);const g={depth:1.5,bevelEnabled:!1};return new ds(u,g)})(),l=new tt(c,a);l.rotation.order="YXZ",l.rotation.y=Math.PI/2,l.rotation.x=-Math.PI/2,l.rotation.z=Math.PI+i.rotation,l.position.set(i.position.x,0,-i.position.z),e.push(l);const h=new tt(c,a);return h.rotation.order="YXZ",h.rotation.y=Math.PI/2,h.rotation.x=-Math.PI/2,h.rotation.z=i.rotation,h.position.set(i.position.x,0,-i.position.z),e.push(h),e}function $v(i,e){const t=Math.cos(i.rotation),n=Math.sin(i.rotation),s=o=>({x:i.position.x+(o.x*t-o.z*n),z:-(i.position.z+(o.x*n+o.z*t))}),r=e.connectionPoints.find(o=>o.name==="in"),a=e.connectionPoints.find(o=>o.name==="out");if(r&&a){const o=s(r.position),c=s(a.position);return{x:(o.x+c.x)/2,z:(o.z+c.z)/2}}if(e.sections.length>0&&e.sections[0].splinePoints.length>0){const o=e.sections[0].splinePoints,c=Math.floor(o.length/2);return s(o[c])}return{x:i.position.x,z:-i.position.z}}function Xv(i,e,t){const n=new _t,s=Mh/2,r=.15,a=.5,o=t({x:0,y:0,z:-s}),c=t({x:0,y:0,z:s}),l=t({x:3,y:0,z:-s}),h=t({x:3,y:0,z:s}),u=new Cn({color:16711680}),d=h.x-o.x,f=h.z-o.z,g=Math.sqrt(d*d+f*f),_=Math.atan2(f,d),p=new On(g,r,r),m=new tt(p,u);m.position.set((o.x+h.x)/2,a,(o.z+h.z)/2),m.rotation.y=-_,n.add(m);const x=l.x-c.x,v=l.z-c.z,S=Math.sqrt(x*x+v*v),C=Math.atan2(v,x),A=new On(S,r,r),w=new tt(A,u);return w.position.set((c.x+l.x)/2,a,(c.z+l.z)/2),w.rotation.y=-C,n.add(w),n}const qv=30,Yv=.4,Zv=1,jv=.75;function Kv(i){return i==="in"||i==="in1"||i==="in2"}function Jv(i,e,t,n,s){const r=[];if(n.length>1){const a=Kv(e)?"bwd":"fwd",o=Qv(i,e,a,n,s,n);r.push(...o)}return r}function Qv(i,e,t,n,s,r){const a=[],o=r.map(g=>`${g.pieceId}.${g.pointName}`);o.push(`${i.id}.${e}`),o.sort();const l=`junction.${o[0]}.${t}`,h=Nv(l);Y.debug(`renderSwitchIndicators: ${l}, ${n.length} connections, selectedIndex=${h}`),n.forEach((g,_)=>Y.debug(`  route[${_}]: ${g.pieceId}.${g.pointName} ${g.isAutoConnect?"(auto)":""}`));const u=[];for(const g of n){const _=ex(g,s);u.push(_)}const d=u.map(g=>{if(!g)return null;const _=ix(g);return tx(g,_)});if(d.filter(g=>g!==null).length<=1)return a;for(let g=0;g<n.length;g++){const _=d[g];if(Y.debug(`  Indicator ${g}: pos=${_?`(${_.x.toFixed(2)}, ${_.z.toFixed(2)})`:"null"}, curveInfo=${u[g]?"valid":"null"}`),!_)continue;const p=g===h,m=p?wv:Av,x=new fs(.6,16,16),v=new $t({color:m}),S=new tt(x,v);S.position.set(_.x,.7,_.z),S.userData={isSwitchIndicator:!0,routeKey:l,connectionIndex:g},Y.debug(`  Created indicator ${g} at (${_.x.toFixed(2)}, 0.7, ${_.z.toFixed(2)}), selected=${p}, color=${p?"green":"red"}`),a.push(S)}return a}function hl(i){return i==="in"?"out":i==="out"?"in":i==="in1"?"out1":i==="out1"?"in1":i==="in2"?"out2":i==="out2"?"in2":"out"}function ex(i,e){const t=e.get(i.pieceId);if(!t)return null;const n=nt(t.archetypeCode);if(!n||n.sections.length===0)return null;const s=n.sections[0];if(s.splinePoints.length<2)return null;const r=Math.cos(t.rotation),a=Math.sin(t.rotation),o=p=>new L(t.position.x+(p.x*r-p.z*a),p.y,-(t.position.z+(p.x*a+p.z*r))),c=s.splinePoints.map(p=>o(p)),l=new In(c),h=l.getLength();if(h===0)return null;const u=i.pointName==="in"||i.pointName==="in1",d=hl(i.pointName),f=t.connections.get(d)||[],g=f.length>1;let _=!1;if(f.length===1){const p=f[0],m=e.get(p.pieceId);if(m){const x=hl(p.pointName),v=m.connections.get(x)||[];if(v.length>1)_=!0;else if(v.length===1){const S=v[0],C=e.get(S.pieceId);C&&(_=(C.connections.get(S.pointName)||[]).length>1)}}}return{curve:l,curveLength:h,isFromIn:u,farEndHasSwitch:g,farEndNextTrackHasSwitch:_}}function tx(i,e){const t=i.isFromIn?Math.min(e/i.curveLength,1):Math.max(1-e/i.curveLength,0),n=i.curve.getPointAt(t);return{x:n.x,z:n.z}}function nx(i){return i.farEndHasSwitch?Yv:i.farEndNextTrackHasSwitch?jv:Zv}function ix(i){const e=nx(i);return Math.min(i.curveLength*e,qv)}const er=4,tr=3,vo=.5;function mn(i,e){const t=nt(i.archetypeCode);if(!t||e>=t.sections.length)return 0;const n=t.sections[e];if(n.splinePoints.length<2)return 0;const s=yh(n.splinePoints,i);return new In(s).getLength()}function yh(i,e){const t=Math.cos(e.rotation),n=Math.sin(e.rotation);return i.map(s=>new L(e.position.x+(s.x*t-s.z*n),s.y,e.position.z+(s.x*n+s.z*t)))}function sx(i,e,t){const n=nt(i.archetypeCode);if(!n||e>=n.sections.length)return null;const s=n.sections[e];if(s.splinePoints.length<2)return{position:{x:i.position.x,y:0,z:i.position.z},rotation:i.rotation};const r=yh(s.splinePoints,i),a=new In(r),o=a.getLength();if(o===0)return{position:{x:i.position.x,y:0,z:i.position.z},rotation:i.rotation};const c=Math.max(0,Math.min(1,t/o)),l=a.getPointAt(c),h=a.getTangentAt(c),u=Math.atan2(h.z,h.x);return{position:{x:l.x,y:0,z:l.z},rotation:u}}function zo(i,e){const t=e.pieces.find(r=>r.id===i.currentPieceId);if(!t)return;const n=Ji(i.entryPoint),s=sx(t,n,i.distanceAlongSection);s&&(i.worldPosition=s.position,i.rotation=s.rotation+(i.sectionDirection===-1?Math.PI:0))}function ni(i){return i==="in"||i==="in1"||i==="in2"}function dr(i){return i==="out"||i==="out1"||i==="out2"}function Ji(i){return i&&(i==="in2"||i==="out2")?1:0}function xo(i,e){return dr(i)&&dr(e)||ni(i)&&ni(e)}function nr(i,e,t,n,s,r,a,o){var x;const c=t.pieces.find(v=>v.id===i);if(!c)return null;const l=c.connections.get(e);if(!l||l.length===0)return null;const h=l.filter(v=>v.pieceId!==r);if(h.length===0)return null;if(h.length===1)return{pieceId:h[0].pieceId,entryPoint:h[0].pointName};const u=h,d=a==="backward"?"bwd":"fwd",f=l.map(v=>`${v.pieceId}.${v.pointName}`);f.push(`${i}.${e}`),f.sort();const _=`junction.${f[0]}.${d}`;let p;s!=null&&s.has(_)?(p=s.get(_),o&&o.add(_)):(t.randomSwitches?p=Math.floor(Math.random()*u.length):p=(x=n.get(_))!=null?x:0,s&&s.set(_,p));const m=u[Math.min(p,u.length-1)];return{pieceId:m.pieceId,entryPoint:m.pointName}}function ea(i){return i==="in"?"out":i==="out"?"in":i==="in1"?"out1":i==="out1"?"in1":i==="in2"?"out2":i==="out2"?"in2":"out"}function rx(i,e,t,n,s,r){i.distanceAlongSection+=e*i.sectionDirection;let a=t.pieces.find(h=>h.id===i.currentPieceId);if(!a)return;let o=Ji(i.entryPoint),c=mn(a,o),l=0;for(;c===0&&l<10;){l++;let h,u;i.entryPoint?(h=ea(i.entryPoint),u=ni(i.entryPoint)?"forward":"backward"):(h=i.distanceAlongSection>=0?"out":"in",u="forward");const d=nr(i.currentPieceId,h,t,n,s,i.previousPieceId,u,r);if(!d){i.distanceAlongSection=0,zo(i,t);return}if(xo(h,d.entryPoint)&&(i.sectionDirection=i.sectionDirection===1?-1:1),i.previousPieceId=i.currentPieceId,i.currentPieceId=d.pieceId,i.entryPoint=d.entryPoint,a=t.pieces.find(f=>f.id===i.currentPieceId),!a)return;o=Ji(i.entryPoint),c=mn(a,o)}for(;i.distanceAlongSection>=c&&c>0;){const h=i.distanceAlongSection-c,u="out",d=nr(i.currentPieceId,u,t,n,s,i.previousPieceId,"forward",r);if(!d){i.distanceAlongSection=c;return}xo(u,d.entryPoint)&&(i.sectionDirection=i.sectionDirection===1?-1:1),i.previousPieceId=i.currentPieceId,i.currentPieceId=d.pieceId,i.entryPoint=d.entryPoint;const f=t.pieces.find(g=>g.id===d.pieceId);if(f){const g=Ji(d.entryPoint),_=mn(f,g);dr(d.entryPoint)?i.distanceAlongSection=_-h:i.distanceAlongSection=h,c=_}else{i.distanceAlongSection=h;break}}for(;i.distanceAlongSection<0&&c>0;){const h="in",u=nr(i.currentPieceId,h,t,n,s,i.previousPieceId,"backward",r);if(!u){i.distanceAlongSection=0;break}const d=t.pieces.find(f=>f.id===u.pieceId);if(d){const f=Ji(u.entryPoint),g=mn(d,f);if(g===0){i.distanceAlongSection=0;break}xo(h,u.entryPoint)&&(i.sectionDirection=i.sectionDirection===1?-1:1);const _=-i.distanceAlongSection;i.previousPieceId=i.currentPieceId,i.currentPieceId=u.pieceId,i.entryPoint=u.entryPoint,ni(u.entryPoint)?i.distanceAlongSection=_:i.distanceAlongSection=g-_,c=g}else break}zo(i,t)}const bh=2,fr=1.5,ox=16747520,Th=[16711680,255,65280,16711935,16776960],ax=[3158064,5263440,7368816,9474192,11579568];let Qi=null;function cx(i="gray"){if(i==="black")return 0;const e=i==="colorful"?Th:ax,t=e.map((r,a)=>Qi!==null&&a===Qi?2:1),n=t.reduce((r,a)=>r+a,0);let s=Math.random()*n;for(let r=0;r<t.length;r++)if(s-=t[r],s<=0)return Qi=r,e[r];return Qi=0,e[0]}function lx(){Qi=null}function hx(){const i=er/2,e=bh/2,t=.25,n=.15,s=i*.35,r=e*.35,a=.15,o=new Bi;return o.moveTo(-i+t,-e),o.quadraticCurveTo(-i,-e,-i,-e+t),o.lineTo(-i,e-t),o.quadraticCurveTo(-i,e,-i+t,e),o.lineTo(s,e),o.lineTo(i-a,r+n),o.quadraticCurveTo(i-a+n*.5,r,i,r),o.lineTo(i,-r),o.quadraticCurveTo(i-a+n*.5,-r,i-a,-r-n),o.lineTo(s,-e),o.lineTo(-i+t,-e),o}function ux(){const i=tr/2,e=bh/2,t=.2,n=new Bi;return n.moveTo(-i+t,-e),n.quadraticCurveTo(-i,-e,-i,-e+t),n.lineTo(-i,e-t),n.quadraticCurveTo(-i,e,-i+t,e),n.lineTo(i-t,e),n.quadraticCurveTo(i,e,i,e-t),n.lineTo(i,-e+t),n.quadraticCurveTo(i,-e,i-t,-e),n.lineTo(-i+t,-e),n}let Zi=null,ji=null,So=null,Mo=null;const ul=new Map;let Eo=null;function wh(){if(!Zi){const i=hx();Zi=new ds(i,{depth:fr,bevelEnabled:!1}),Zi.rotateX(-Math.PI/2),Zi.translate(0,fr/2,0)}return Zi}function Ah(){if(!ji){const i=ux();ji=new ds(i,{depth:fr,bevelEnabled:!1}),ji.rotateX(-Math.PI/2),ji.translate(0,fr/2,0)}return ji}function dx(){return So||(So=new oh(wh(),15)),So}function fx(){return Mo||(Mo=new oh(Ah(),15)),Mo}function px(i){let e=ul.get(i);return e||(e=new Cn({color:i,roughness:.5,metalness:.1}),ul.set(i,e)),e}function mx(){return Eo||(Eo=new eh({color:0,linewidth:1})),Eo}function gx(i){const e=new _t;for(const t of i){const n=_x(t);e.add(n)}return e}function _x(i){const e=new _t;e.name=i.id;for(const t of i.cars){const n=vx(t);e.add(n)}return e}function vx(i){var d;const e=i.type==="cab",t=e?wh():Ah(),n=e?dx():fx(),s=e?ox:(d=i.color)!=null?d:Th[0],r=px(s),a=new tt(t,r),o=new d_(n,mx()),c=new _t;c.name=i.id,c.add(a),c.add(o);const l=i.worldPosition.x,h=-i.worldPosition.z,u=i.rotation;return Number.isNaN(l)||Number.isNaN(h)||Number.isNaN(u)?(Y.error(`NaN detected in car ${i.id}: pos=(${l}, ${h}), rot=${u}`),c.visible=!1):(c.position.set(l,0,h),c.rotation.y=u),c.visible=i.visible,c}var k=(i=>(i.IDENTIFIER="IDENTIFIER",i.LABEL_DEF="LABEL_DEF",i.LABEL_REF="LABEL_REF",i.DOT="DOT",i.REPETITION="REPETITION",i.NUMBER="NUMBER",i.RANGE="RANGE",i.STRING="STRING",i.NEW="NEW",i.LOOP_CLOSE="LOOP_CLOSE",i.TITLE="TITLE",i.DESCRIPTION="DESCRIPTION",i.LOCKAHEAD="LOCKAHEAD",i.DISTANCE="DISTANCE",i.COUNT="COUNT",i.DEGREES="DEGREES",i.OFFSET="OFFSET",i.BASE="BASE",i.SPLICE="SPLICE",i.USING="USING",i.CABS="CABS",i.CARS="CARS",i.SPEED="SPEED",i.EVERY="EVERY",i.COLORFUL="COLORFUL",i.GRAY="GRAY",i.BLACK="BLACK",i.RANDOM="RANDOM",i.MAX="MAX",i.TRAINS="TRAINS",i.FLEX="FLEX",i.CONNECT="CONNECT",i.CROSS="CROSS",i.DEFINE="DEFINE",i.LEFT="LEFT",i.RIGHT="RIGHT",i.STRAIGHT="STRAIGHT",i.RADIUS="RADIUS",i.ARC="ARC",i.LENGTH="LENGTH",i.ARRAY="ARRAY",i.ANGLE="ANGLE",i.PREFIX="PREFIX",i.LOG="LOG",i.PREFAB="PREFAB",i.USE="USE",i.TREES="TREES",i.CLEARANCE="CLEARANCE",i.DENSITY="DENSITY",i.FACTOR="FACTOR",i.GRID="GRID",i.NONE="NONE",i.POND="POND",i.SIZE="SIZE",i.SCORE="SCORE",i.EOF="EOF",i))(k||{});function xx(i){const e=[],t=i.split(`
